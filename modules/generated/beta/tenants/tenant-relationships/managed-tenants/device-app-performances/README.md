...
Lifecycle: `POST /tenantRelationships/managedTenants/deviceAppPerformances`, `GET/PATCH/DELETE /tenantRelationships/managedTenants/deviceAppPerformances/{deviceAppPerformance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tenants/tenant-relationships/managed-tenants/device-app-performances"
}
```
...
| `is_latest_used_version` | `isLatestUsedVersion` | `number` | no | no |
| `is_most_used_version` | `isMostUsedVersion` | `number` | no | no |
