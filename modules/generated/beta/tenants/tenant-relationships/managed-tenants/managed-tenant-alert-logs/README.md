...
Lifecycle: `POST /tenantRelationships/managedTenants/managedTenantAlertLogs`, `GET/PATCH/DELETE /tenantRelationships/managedTenants/managedTenantAlertLogs/{managedTenantAlertLog-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tenants/tenant-relationships/managed-tenants/managed-tenant-alert-logs"
}
```
