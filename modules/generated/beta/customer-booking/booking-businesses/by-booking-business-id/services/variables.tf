...
variable "created_date_time" {
  description = "The date, time and timezone when the Service was created."
  type        = string
  default     = null
}
...
variable "default_price_type" {
  ...
  validation {
    condition     = var.default_price_type == null ? true : contains(["undefined", "fixedPrice", "startingAt", "hourly", "free", "priceVaries", "callUs", "notSet"], var.default_price_type)
...
variable "is_hidden_from_customers" {
  description = "True means this service isn't available to customers for booking."
  type        = bool
  default     = null
}
...
variable "last_updated_date_time" {
  description = "The date, time and timezone when the Service  was last updated."
  type        = string
  default     = null
}
