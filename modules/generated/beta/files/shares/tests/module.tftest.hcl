...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["createdByUser", "description", "driveItem", "items", "lastModifiedByUser", "list", "listItem", "name", "owner", "parentReference", "permission", "root", "site"] : !contains(keys(msgraph_resource.this.body), key)])
