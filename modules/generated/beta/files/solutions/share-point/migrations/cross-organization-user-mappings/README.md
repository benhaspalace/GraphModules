# /solutions/sharePoint/migrations/crossOrganizationUserMappings

Create new navigation property to crossOrganizationUserMappings for solutions

[Catalog](../../../../../README.md) · [Files](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/sharepointuseridentitymapping?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /solutions/sharePoint/migrations/crossOrganizationUserMappings`, `GET/PATCH/DELETE /solutions/sharePoint/migrations/crossOrganizationUserMappings/{sharePointUserIdentityMapping-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./files/solutions/share-point/migrations/cross-organization-user-mappings"
}
```
