...
Lifecycle: `POST /storage/fileStorage/containers/{fileStorageContainer-id}/sharePointGroups`, `GET/PATCH/DELETE /storage/fileStorage/containers/{fileStorageContainer-id}/sharePointGroups/{sharePointGroup-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./files/storage/file-storage/containers/by-file-storage-container-id/share-point-groups"
