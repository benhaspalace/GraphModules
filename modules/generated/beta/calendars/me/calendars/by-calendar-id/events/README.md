...
Lifecycle: `POST /me/calendars/{calendar-id}/events`, `GET/PATCH/DELETE /me/calendars/{calendar-id}/events/{event-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/me/calendars/by-calendar-id/events"
