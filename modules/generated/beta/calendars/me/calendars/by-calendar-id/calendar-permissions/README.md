...
Lifecycle: `POST /me/calendars/{calendar-id}/calendarPermissions`, `GET/PATCH/DELETE /me/calendars/{calendar-id}/calendarPermissions/{calendarPermission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/me/calendars/by-calendar-id/calendar-permissions"
