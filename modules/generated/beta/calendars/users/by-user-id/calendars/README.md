...
Lifecycle: `POST /users/{user-id}/calendars`, `GET/PATCH/DELETE /users/{user-id}/calendars/{calendar-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/users/by-user-id/calendars"
...
| `calendar_group_id` | `calendarGroupId` | `string` | no | no |
