...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "users/test-parent-id/calendarGroups/test-parent-id/calendars/test-parent-id/events"
    error_message = "The collection URL must include parent identifiers and exclude the API-version prefix."
  }

  assert {
    condition     = alltrue([for key in ["allowNewTimeProposals", "attendees", "body", "bodyPreview", "cancelledOccurrences", "categories", "createdDateTime", "end", "exceptionOccurrences", "extensions", "hasAttachments", "hideAttendees", "importance", "isAllDay", "isCancelled", "isDraft", "isOnlineMeeting", "isOrganizer", "isReminderOn", "lastModifiedDateTime", "location", "locations", "occurrenceId", "onlineMeetingProvider", "organizer", "originalEndTimeZone", "originalStart", "originalStartTimeZone", "recurrence", "reminderMinutesBeforeStart", "responseRequested", "responseStatus", "sensitivity", "seriesMasterId", "showAs", "start", "subject", "transactionId", "uid", "webLink"] : !contains(keys(msgraph_resource.this.body), key)])
