...
[Catalog](../../../../../../README.md) · [Calendars](../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/calendar?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/calendarGroups/{calendarGroup-id}/calendars`, `GET/PATCH/DELETE /users/{user-id}/calendarGroups/{calendarGroup-id}/calendars/{calendar-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/users/by-user-id/calendar-groups/by-calendar-group-id/calendars"
