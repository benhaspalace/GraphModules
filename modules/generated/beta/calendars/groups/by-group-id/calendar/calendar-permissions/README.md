...
Lifecycle: `POST /groups/{group-id}/calendar/calendarPermissions`, `GET/PATCH/DELETE /groups/{group-id}/calendar/calendarPermissions/{calendarPermission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/groups/by-group-id/calendar/calendar-permissions"
