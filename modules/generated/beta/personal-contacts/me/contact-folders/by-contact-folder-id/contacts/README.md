...
Lifecycle: `POST /me/contactFolders/{contactFolder-id}/contacts`, `GET/PATCH/DELETE /me/contactFolders/{contactFolder-id}/contacts/{contact-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./personal-contacts/me/contact-folders/by-contact-folder-id/contacts"
