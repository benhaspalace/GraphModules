...
Lifecycle: `POST /users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}/contacts`, `GET/PATCH/DELETE /users/{user-id}/contactFolders/{contactFolder-id}/childFolders/{contactFolder-id1}/contacts/{contact-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./personal-contacts/users/by-user-id/contact-folders/by-contact-folder-id/child-folders/by-contact-folder-id1/contacts"
