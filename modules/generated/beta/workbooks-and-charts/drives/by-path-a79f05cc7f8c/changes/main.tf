...
resource "msgraph_resource" "this" {
  url                     = "drives/${urlencode(var.drive_id)}/items/${urlencode(var.drive_item_id)}/workbook/worksheets/${urlencode(var.workbook_worksheet_id)}/tasks/${urlencode(var.workbook_document_task_id)}/changes"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
