...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/task/comment/replies/{workbookCommentReply-id}/task/changes`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/task/comment/replies/{workbookCommentReply-id}/task/changes/{workbookDocumentTaskChange-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./workbooks-and-charts/drives/by-path-8f00abfec432/changes"
