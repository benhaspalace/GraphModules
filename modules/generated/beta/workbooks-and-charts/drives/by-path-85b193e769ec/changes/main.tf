...
resource "msgraph_resource" "this" {
  url                     = "drives/${urlencode(var.drive_id)}/items/${urlencode(var.drive_item_id)}/workbook/comments/${urlencode(var.workbook_comment_id)}/replies/${urlencode(var.workbook_comment_reply_id)}/task/comment/task/changes"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
