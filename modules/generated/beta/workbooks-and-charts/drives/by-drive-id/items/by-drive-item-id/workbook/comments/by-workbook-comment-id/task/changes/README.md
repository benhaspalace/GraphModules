# /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/task/changes
...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/task/changes`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/comments/{workbookComment-id}/task/changes/{workbookDocumentTaskChange-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./workbooks-and-charts/drives/by-drive-id/items/by-drive-item-id/workbook/comments/by-workbook-comment-id/task/changes"
