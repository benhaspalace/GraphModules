...
Lifecycle: `POST /sites/{site-id}/onenote/notebooks`, `GET/PATCH/DELETE /sites/{site-id}/onenote/notebooks/{notebook-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/sites/by-site-id/onenote/notebooks"
