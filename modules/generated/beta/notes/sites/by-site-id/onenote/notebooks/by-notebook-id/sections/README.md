...
Lifecycle: `POST /sites/{site-id}/onenote/notebooks/{notebook-id}/sections`, `GET/PATCH/DELETE /sites/{site-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}`.
