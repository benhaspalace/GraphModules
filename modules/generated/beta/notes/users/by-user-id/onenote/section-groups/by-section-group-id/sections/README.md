...
Lifecycle: `POST /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections`, `GET/PATCH/DELETE /users/{user-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/users/by-user-id/onenote/section-groups/by-section-group-id/sections"
