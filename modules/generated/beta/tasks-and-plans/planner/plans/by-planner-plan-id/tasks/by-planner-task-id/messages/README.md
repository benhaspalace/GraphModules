# /planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/messages
...
Lifecycle: `POST /planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/messages`, `GET/PATCH/DELETE /planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}/messages/{plannerTaskChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/planner/plans/by-planner-plan-id/tasks/by-planner-task-id/messages"
