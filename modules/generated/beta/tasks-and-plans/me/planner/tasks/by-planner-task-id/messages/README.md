# /me/planner/tasks/{plannerTask-id}/messages
...
Lifecycle: `POST /me/planner/tasks/{plannerTask-id}/messages`, `GET/PATCH/DELETE /me/planner/tasks/{plannerTask-id}/messages/{plannerTaskChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/me/planner/tasks/by-planner-task-id/messages"
