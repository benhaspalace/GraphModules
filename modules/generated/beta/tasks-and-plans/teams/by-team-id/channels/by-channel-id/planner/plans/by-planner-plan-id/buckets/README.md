...
Lifecycle: `POST /teams/{team-id}/channels/{channel-id}/planner/plans/{plannerPlan-id}/buckets`, `GET/PATCH/DELETE /teams/{team-id}/channels/{channel-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/teams/by-team-id/channels/by-channel-id/planner/plans/by-planner-plan-id/buckets"
