...
Lifecycle: `POST /teams/{team-id}/primaryChannel/planner/plans/{plannerPlan-id}/tasks`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/teams/by-team-id/primary-channel/planner/plans/by-planner-plan-id/tasks"
