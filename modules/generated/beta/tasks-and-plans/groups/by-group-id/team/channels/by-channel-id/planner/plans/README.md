...
Lifecycle: `POST /groups/{group-id}/team/channels/{channel-id}/planner/plans`, `GET/PATCH/DELETE /groups/{group-id}/team/channels/{channel-id}/planner/plans/{plannerPlan-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/groups/by-group-id/team/channels/by-channel-id/planner/plans"
