...
Lifecycle: `POST /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets`, `GET/PATCH/DELETE /groups/{group-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/groups/by-group-id/planner/plans/by-planner-plan-id/buckets"
