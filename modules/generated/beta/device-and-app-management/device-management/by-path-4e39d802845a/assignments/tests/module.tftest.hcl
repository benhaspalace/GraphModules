...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/reusablePolicySettings/test-parent-id/referencingConfigurationPolicies/test-parent-id/assignments"
