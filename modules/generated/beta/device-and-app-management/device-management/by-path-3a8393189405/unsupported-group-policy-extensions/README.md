...
Lifecycle: `POST /deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport-id}/unsupportedGroupPolicyExtensions`, `GET/PATCH/DELETE /deviceManagement/groupPolicyMigrationReports/{groupPolicyMigrationReport-id}/unsupportedGroupPolicyExtensions/{unsupportedGroupPolicyExtension-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/by-path-3a8393189405/unsupported-group-policy-extensions"
...
| `extension_type` | `extensionType` | `string` | no | no |
| `namespace_url` | `namespaceUrl` | `string` | no | no |
| `node_name` | `nodeName` | `string` | no | no |
