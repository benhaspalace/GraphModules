...
Lifecycle: `POST /deviceManagement/comanagedDevices`, `GET/PATCH/DELETE /deviceManagement/comanagedDevices/{managedDevice-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/comanaged-devices"
}
```
