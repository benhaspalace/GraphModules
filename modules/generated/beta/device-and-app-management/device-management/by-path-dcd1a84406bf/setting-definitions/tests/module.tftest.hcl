...
run "minimal_request" {
  ...
  variables {
    ...
    device_management_intent_setting_category_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/intents/test-parent-id/categories/test-parent-id/settingDefinitions"
