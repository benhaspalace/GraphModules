...
resource "msgraph_resource" "this" {
  url                     = "deviceManagement/intents/${urlencode(var.device_management_intent_id)}/categories/${urlencode(var.device_management_intent_setting_category_id)}/settingDefinitions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
