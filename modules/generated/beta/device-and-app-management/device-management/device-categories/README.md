...
Lifecycle: `POST /deviceManagement/deviceCategories`, `GET/PATCH/DELETE /deviceManagement/deviceCategories/{deviceCategory-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/device-categories"
}
```
