...
Lifecycle: `POST /deviceManagement/windowsQualityUpdatePolicies`, `GET/PATCH/DELETE /deviceManagement/windowsQualityUpdatePolicies/{windowsQualityUpdatePolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/windows-quality-update-policies"
}
```
