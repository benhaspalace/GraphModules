...
Lifecycle: `POST /deviceManagement/complianceSettings`, `GET/PATCH/DELETE /deviceManagement/complianceSettings/{deviceManagementConfigurationSettingDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/compliance-settings"
}
```
