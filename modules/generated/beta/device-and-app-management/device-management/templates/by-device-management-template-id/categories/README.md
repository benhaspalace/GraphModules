...
Lifecycle: `POST /deviceManagement/templates/{deviceManagementTemplate-id}/categories`, `GET/PATCH/DELETE /deviceManagement/templates/{deviceManagementTemplate-id}/categories/{deviceManagementTemplateSettingCategory-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/templates/by-device-management-template-id/categories"
