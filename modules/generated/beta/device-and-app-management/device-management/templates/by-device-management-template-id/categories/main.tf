...
locals {
  typed_body = { for key, value in {
    ...
    "recommendedSettings" = (var.recommended_settings == null ? null : [for item0 in var.recommended_settings : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "definitionId" = item0["definitionId"], "valueJson" = item0["valueJson"] } : key1 => value1 if value1 != null }) if item0 != null])
...
resource "msgraph_resource" "this" {
  url                     = "deviceManagement/templates/${urlencode(var.device_management_template_id)}/categories"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
