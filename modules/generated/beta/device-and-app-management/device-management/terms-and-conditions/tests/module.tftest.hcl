...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["acceptanceStatement", "acceptanceStatuses", "assignments", "bodyText", "createdDateTime", "description", "displayName", "version", "groupAssignments", "lastModifiedDateTime", "modifiedDateTime", "roleScopeTagIds", "title"] : !contains(keys(msgraph_resource.this.body), key)])
