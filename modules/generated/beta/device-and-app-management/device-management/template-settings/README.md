...
Lifecycle: `POST /deviceManagement/templateSettings`, `GET/PATCH/DELETE /deviceManagement/templateSettings/{deviceManagementConfigurationSettingTemplate-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/template-settings"
}
```
