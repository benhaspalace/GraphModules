...
Lifecycle: `POST /deviceManagement/elevationRequests`, `GET/PATCH/DELETE /deviceManagement/elevationRequests/{privilegeManagementElevationRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/elevation-requests"
}
```
...
| `reviewer_justification` | `reviewerJustification` | `string` | no | no |
