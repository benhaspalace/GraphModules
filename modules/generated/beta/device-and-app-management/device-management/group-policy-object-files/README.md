...
Lifecycle: `POST /deviceManagement/groupPolicyObjectFiles`, `GET/PATCH/DELETE /deviceManagement/groupPolicyObjectFiles/{groupPolicyObjectFile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/group-policy-object-files"
}
```
