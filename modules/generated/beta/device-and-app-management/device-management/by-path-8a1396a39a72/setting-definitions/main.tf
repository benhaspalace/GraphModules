...
resource "msgraph_resource" "this" {
  url                     = "deviceManagement/templates/${urlencode(var.device_management_template_id)}/migratableTo/${urlencode(var.device_management_template_id1)}/categories/${urlencode(var.device_management_template_setting_category_id)}/settingDefinitions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
