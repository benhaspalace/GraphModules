...
run "minimal_request" {
  ...
  variables {
    ...
    device_management_template_setting_category_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/templates/test-parent-id/migratableTo/test-parent-id/categories/test-parent-id/settingDefinitions"
...
run "invalid_enum" {
  ...
  variables {
    ...
    device_management_template_id1                 = "test-parent-id"
    device_management_template_setting_category_id = "test-parent-id"
    value_type                                     = "__graphmodules_invalid_enum__"
  }
