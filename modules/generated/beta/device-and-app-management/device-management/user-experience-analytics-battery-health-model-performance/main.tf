...
locals {
  typed_body = { for key, value in {
    ...
    "model"                            = var.model
    "modelBatteryHealthScore"          = var.model_battery_health_score
    "modelHealthStatus"                = var.model_health_status
...
resource "msgraph_resource" "this" {
  url                     = "deviceManagement/userExperienceAnalyticsBatteryHealthModelPerformance"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
