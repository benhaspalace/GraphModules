...
resource "msgraph_resource" "this" {
  url                     = "deviceManagement/deviceManagementScripts/${urlencode(var.device_management_script_id)}/userRunStates/${urlencode(var.device_management_script_user_state_id)}/deviceRunStates"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
