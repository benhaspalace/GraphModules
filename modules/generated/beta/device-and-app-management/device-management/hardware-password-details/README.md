...
Lifecycle: `POST /deviceManagement/hardwarePasswordDetails`, `GET/PATCH/DELETE /deviceManagement/hardwarePasswordDetails/{hardwarePasswordDetail-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/hardware-password-details"
}
```
