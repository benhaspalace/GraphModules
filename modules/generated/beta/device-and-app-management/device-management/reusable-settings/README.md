...
Lifecycle: `POST /deviceManagement/reusableSettings`, `GET/PATCH/DELETE /deviceManagement/reusableSettings/{deviceManagementConfigurationSettingDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/reusable-settings"
}
```
