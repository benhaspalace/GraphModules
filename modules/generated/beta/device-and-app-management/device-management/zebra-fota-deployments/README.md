...
Lifecycle: `POST /deviceManagement/zebraFotaDeployments`, `GET/PATCH/DELETE /deviceManagement/zebraFotaDeployments/{zebraFotaDeployment-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/zebra-fota-deployments"
}
```
