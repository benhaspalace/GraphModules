...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["androidEnrollmentAssignments", "androidOnboarded", "displayName", "iosEnrollmentAssignments", "iosOnboarded", "lastHeartbeatDateTime", "linuxEnrollmentAssignments", "linuxOnboarded", "macOsEnrollmentAssignments", "macOsOnboarded", "partnerState"] : !contains(keys(msgraph_resource.this.body), key)])
