# /admin/windows/updates/policies/{policy-id}/rings

Create ring

[Catalog](../../../../../../../README.md) · [Device and app management](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/windowsupdates-ring?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /admin/windows/updates/policies/{policy-id}/rings`, `GET/PATCH/DELETE /admin/windows/updates/policies/{policy-id}/rings/{ring-id}`.
