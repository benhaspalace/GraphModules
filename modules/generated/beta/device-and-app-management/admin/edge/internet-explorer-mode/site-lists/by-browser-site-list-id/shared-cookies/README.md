...
[Catalog](../../../../../../../README.md) · [Device and app management](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/browsersharedcookie?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /admin/edge/internetExplorerMode/siteLists/{browserSiteList-id}/sharedCookies`, `GET/PATCH/DELETE /admin/edge/internetExplorerMode/siteLists/{browserSiteList-id}/sharedCookies/{browserSharedCookie-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/admin/edge/internet-explorer-mode/site-lists/by-browser-site-list-id/shared-cookies"
...
| `path` | `path` | `string` | no | no |
| `source_environment` | `sourceEnvironment` | `string` | no | no |
