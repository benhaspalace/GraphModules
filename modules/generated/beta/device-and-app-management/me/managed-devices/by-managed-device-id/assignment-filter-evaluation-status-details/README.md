...
Lifecycle: `POST /me/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails`, `GET/PATCH/DELETE /me/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/me/managed-devices/by-managed-device-id/assignment-filter-evaluation-status-details"
