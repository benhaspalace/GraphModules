...
Lifecycle: `POST /deviceAppManagement/mobileAppCatalogPackages`, `GET/PATCH/DELETE /deviceAppManagement/mobileAppCatalogPackages/{mobileAppCatalogPackage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-app-management/mobile-app-catalog-packages"
}
```
