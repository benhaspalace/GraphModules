...
locals {
  typed_body = { for key, value in {
    ...
    "appActionIfDeveloperOptionsEnabled"                 = var.app_action_if_developer_options_enabled
    ...
    "appActionIfSamsungKnoxAttestationRequired"          = var.app_action_if_samsung_knox_attestation_required
    "appActionIfUnableToAuthenticateUser"                = var.app_action_if_unable_to_authenticate_user
    "appGroupType"                                       = var.app_group_type
    "approvedKeyboards"                                  = (var.approved_keyboards == null ? null : [for item0 in var.approved_keyboards : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "name" = item0["name"], "value" = item0["value"] } : key1 => value1 if value1 != null }) if item0 != null])
    ...
    "keyboardsRestricted"                                = var.keyboards_restricted
