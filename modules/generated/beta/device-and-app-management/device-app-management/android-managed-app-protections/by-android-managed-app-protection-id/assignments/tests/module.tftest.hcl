...
run "minimal_request" {
  ...
  variables {
    android_managed_app_protection_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "deviceAppManagement/androidManagedAppProtections/test-parent-id/assignments"
