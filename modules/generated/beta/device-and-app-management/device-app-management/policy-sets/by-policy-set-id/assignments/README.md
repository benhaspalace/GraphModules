...
Lifecycle: `POST /deviceAppManagement/policySets/{policySet-id}/assignments`, `GET/PATCH/DELETE /deviceAppManagement/policySets/{policySet-id}/assignments/{policySetAssignment-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-app-management/policy-sets/by-policy-set-id/assignments"
