...
Lifecycle: `POST /print/printerShares/{printerShare-id}/jobs`, `GET/PATCH/DELETE /print/printerShares/{printerShare-id}/jobs/{printJob-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/print/printer-shares/by-printer-share-id/jobs"
