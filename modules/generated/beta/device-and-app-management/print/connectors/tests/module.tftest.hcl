...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["appVersion", "deviceHealth", "displayName", "fullyQualifiedDomainName", "location", "name", "operatingSystem", "registeredDateTime"] : !contains(keys(msgraph_resource.this.body), key)])
