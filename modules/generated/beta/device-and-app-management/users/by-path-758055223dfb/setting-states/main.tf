...
resource "msgraph_resource" "this" {
  url                     = "users/${urlencode(var.user_id)}/managedDevices/${urlencode(var.managed_device_id)}/securityBaselineStates/${urlencode(var.security_baseline_state_id)}/settingStates"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
