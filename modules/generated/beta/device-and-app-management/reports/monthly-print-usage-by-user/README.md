...
Lifecycle: `POST /reports/monthlyPrintUsageByUser`, `GET/PATCH/DELETE /reports/monthlyPrintUsageByUser/{printUsageByUser-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/reports/monthly-print-usage-by-user"
}
```
