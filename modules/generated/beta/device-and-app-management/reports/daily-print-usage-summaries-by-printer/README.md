...
Lifecycle: `POST /reports/dailyPrintUsageSummariesByPrinter`, `GET/PATCH/DELETE /reports/dailyPrintUsageSummariesByPrinter/{printUsageByPrinter-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/reports/daily-print-usage-summaries-by-printer"
}
```
