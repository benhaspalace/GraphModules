...
Lifecycle: `POST /me/todo/lists/{todoTaskList-id}/tasks`, `GET/PATCH/DELETE /me/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./to-do-tasks/me/todo/lists/by-todo-task-list-id/tasks"
