...
Lifecycle: `POST /users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/tasks`, `GET/PATCH/DELETE /users/{user-id}/outlook/taskGroups/{outlookTaskGroup-id}/taskFolders/{outlookTaskFolder-id}/tasks/{outlookTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./to-do-tasks/users/by-user-id/outlook/task-groups/by-outlook-task-group-id/task-folders/by-outlook-task-folder-id/tasks"
