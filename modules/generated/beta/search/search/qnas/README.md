...
[Catalog](../../../README.md) · [Search](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/search-qna?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /search/qnas`, `GET/PATCH/DELETE /search/qnas/{qna-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./search/search/qnas"
}
```
