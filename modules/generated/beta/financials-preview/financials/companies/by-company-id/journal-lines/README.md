...
Lifecycle: `POST /financials/companies/{company-id}/journalLines`, `GET/PATCH/DELETE /financials/companies/{company-id}/journalLines/{journalLine-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./financials-preview/financials/companies/by-company-id/journal-lines"
