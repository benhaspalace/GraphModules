...
[Catalog](../../../../README.md) · [Reports](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/healthmonitoring-alert?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /reports/healthMonitoring/alerts`, `GET/PATCH/DELETE /reports/healthMonitoring/alerts/{alert-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/reports/health-monitoring/alerts"
}
```
