...
[Catalog](../../../README.md) · [Reports](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/customsecurityattributeaudit?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /auditLogs/customSecurityAttributeAudits`, `GET/PATCH/DELETE /auditLogs/customSecurityAttributeAudits/{customSecurityAttributeAudit-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/audit-logs/custom-security-attribute-audits"
}
```
