...
Lifecycle: `POST /users/{user-id}/informationProtection/threatAssessmentRequests`, `GET/PATCH/DELETE /users/{user-id}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/users/by-user-id/information-protection/threat-assessment-requests"
