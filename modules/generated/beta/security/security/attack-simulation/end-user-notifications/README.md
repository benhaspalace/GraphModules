...
[Catalog](../../../../README.md) · [Security](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/endusernotification?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /security/attackSimulation/endUserNotifications`, `GET/PATCH/DELETE /security/attackSimulation/endUserNotifications/{endUserNotification-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/attack-simulation/end-user-notifications"
}
```
