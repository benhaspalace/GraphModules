...
[Catalog](../../../README.md) · [Security](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/security-incident?view=graph-rest-beta&preserve-view=true)
...
| `recommended_actions` | `recommendedActions` | `string` | no | no |
| `recommended_hunting_queries` | `recommendedHuntingQueries` | `list(object({       odata_type = optional(string, "#microsoft.graph.security.recommendedHuntingQuery")       kqlText = optional(string)     }))` | no | no |
