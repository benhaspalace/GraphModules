...
Lifecycle: `POST /security/cloudAppSecurityProfiles`, `GET/PATCH/DELETE /security/cloudAppSecurityProfiles/{cloudAppSecurityProfile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/cloud-app-security-profiles"
}
```
...
| `deployment_package_url` | `deploymentPackageUrl` | `string` | no | no |
| `destination_service_name` | `destinationServiceName` | `string` | no | no |
| `is_signed` | `isSigned` | `bool` | no | no |
