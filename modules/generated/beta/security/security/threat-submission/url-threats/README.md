...
[Catalog](../../../../README.md) · [Security](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/security-urlthreatsubmission?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /security/threatSubmission/urlThreats`, `GET/PATCH/DELETE /security/threatSubmission/urlThreats/{urlThreatSubmission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/threat-submission/url-threats"
}
```
