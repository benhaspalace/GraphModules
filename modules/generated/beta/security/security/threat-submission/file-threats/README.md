...
[Catalog](../../../../README.md) · [Security](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/security-filethreatsubmission?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /security/threatSubmission/fileThreats`, `GET/PATCH/DELETE /security/threatSubmission/fileThreats/{fileThreatSubmission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/threat-submission/file-threats"
}
```
