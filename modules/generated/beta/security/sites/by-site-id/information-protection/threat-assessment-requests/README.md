...
Lifecycle: `POST /sites/{site-id}/informationProtection/threatAssessmentRequests`, `GET/PATCH/DELETE /sites/{site-id}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}`.
