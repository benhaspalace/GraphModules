...
Lifecycle: `POST /sites/{site-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels`, `GET/PATCH/DELETE /sites/{site-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/sites/by-site-id/information-protection/sensitivity-labels/by-sensitivity-label-id/sublabels"
