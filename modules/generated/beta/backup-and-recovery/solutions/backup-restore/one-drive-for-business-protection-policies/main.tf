...
locals {
  typed_body = { for key, value in {
    ...
    "driveExclusionUnits"                  = (var.drive_exclusion_units == null ? null : [for item0 in var.drive_exclusion_units : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "createdBy" = item0["createdBy"], "createdDateTime" = item0["createdDateTime"], "directoryObjectId" = item0["directoryObjectId"], "error" = item0["error"], "lastModifiedBy" = item0["lastModifiedBy"], "lastModifiedDateTime" = item0["lastModifiedDateTime"], "policyId" = item0["policyId"] } : key1 => value1 if value1 != null }) if item0 != null])
    "driveExclusionUnitsBulkAdditionJobs"  = (var.drive_exclusion_units_bulk_addition_jobs == null ? null : [for item0 in var.drive_exclusion_units_bulk_addition_jobs : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "createdBy" = item0["createdBy"], "createdDateTime" = item0["createdDateTime"], "displayName" = item0["displayName"], "drives" = (item0["drives"] == null ? null : [for item2 in item0["drives"] : item2 if item2 != null]), "error" = item0["error"], "lastModifiedBy" = item0["lastModifiedBy"], "lastModifiedDateTime" = item0["lastModifiedDateTime"], "status" = item0["status"] } : key1 => value1 if value1 != null }) if item0 != null])
