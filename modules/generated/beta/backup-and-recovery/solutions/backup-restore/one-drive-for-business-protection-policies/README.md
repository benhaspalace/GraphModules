...
[Catalog](../../../../README.md) · [Backup and recovery](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/onedriveforbusinessprotectionpolicy?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /solutions/backupRestore/oneDriveForBusinessProtectionPolicies`, `GET/PATCH/DELETE /solutions/backupRestore/oneDriveForBusinessProtectionPolicies/{oneDriveForBusinessProtectionPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./backup-and-recovery/solutions/backup-restore/one-drive-for-business-protection-policies"
}
```
...
| `drive_exclusion_units` | `driveExclusionUnits` | `list(object({       odata_type = optional(string, "#microsoft.graph.driveExclusionUnit")       createdBy = optional(any)       createdDateTime = optional(string)       directoryObjectId = optional(string)       error = optional(any)       lastModifiedBy = optional(any)       lastModifiedDateTime = optional(string)       policyId = optional(string)     }))` | no | no |
| `drive_exclusion_units_bulk_addition_jobs` | `driveExclusionUnitsBulkAdditionJobs` | `list(object({       odata_type = optional(string, "#microsoft.graph.driveExclusionUnitsBulkAdditionJob")       createdBy = optional(any)       createdDateTime = optional(string)       displayName = optional(string)       drives = optional(list(string))       error = optional(any)       lastModifiedBy = optional(any)       lastModifiedDateTime = optional(string)       status = optional(string)     }))` | no | no |
...
- driveExclusionUnitsBulkAdditionJobs[].createdBy: polymorphic schema; accepts an untyped value
- driveExclusionUnitsBulkAdditionJobs[].error: polymorphic schema; accepts an untyped value
- driveExclusionUnitsBulkAdditionJobs[].lastModifiedBy: polymorphic schema; accepts an untyped value
- driveExclusionUnits[].createdBy: polymorphic schema; accepts an untyped value
- driveExclusionUnits[].error: polymorphic schema; accepts an untyped value
- driveExclusionUnits[].lastModifiedBy: polymorphic schema; accepts an untyped value
