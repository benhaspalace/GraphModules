...
[Catalog](../../../../README.md) · [Backup and recovery](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/onedriveforbusinessrestoresession?view=graph-rest-beta&preserve-view=true)
...
| `granular_drive_restore_artifacts` | `granularDriveRestoreArtifacts` | `list(object({       odata_type = optional(string, "#microsoft.graph.granularDriveRestoreArtifact")       browseSessionId = optional(string)       completionDateTime = optional(string)       destinationType = optional(any)       directoryObjectId = optional(string)       error = optional(any)       restorePointDateTime = optional(string)       restoredItemKey = optional(string)       restoredItemPath = optional(string)       restoredItemWebUrl = optional(string)       startDateTime = optional(string)       status = optional(string)       webUrl = optional(string)     }))` | no | no |
...
- granularDriveRestoreArtifacts[].destinationType: polymorphic schema; accepts an untyped value
- granularDriveRestoreArtifacts[].error: polymorphic schema; accepts an untyped value
