...
Lifecycle: `POST /users/{user-id}/informationProtection/dataLossPreventionPolicies`, `GET/PATCH/DELETE /users/{user-id}/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/users/by-user-id/information-protection/data-loss-prevention-policies"
