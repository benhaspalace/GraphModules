...
Lifecycle: `POST /users/{user-id}/deviceEnrollmentConfigurations`, `GET/PATCH/DELETE /users/{user-id}/deviceEnrollmentConfigurations/{deviceEnrollmentConfiguration-id}`.
