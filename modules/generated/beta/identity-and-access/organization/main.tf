...
locals {
  typed_body = { for key, value in {
    ...
    "onPremisesLastPasswordSyncDateTime"   = var.on_premises_last_password_sync_date_time
    "onPremisesLastSyncDateTime"           = var.on_premises_last_sync_date_time
    "onPremisesSyncEnabled"                = var.on_premises_sync_enabled
    "partnerInformation"                   = var.partner_information
