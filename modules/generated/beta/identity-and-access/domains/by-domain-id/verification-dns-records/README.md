...
Lifecycle: `POST /domains/{domain-id}/verificationDnsRecords`, `GET/PATCH/DELETE /domains/{domain-id}/verificationDnsRecords/{domainDnsRecord-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/domains/by-domain-id/verification-dns-records"
