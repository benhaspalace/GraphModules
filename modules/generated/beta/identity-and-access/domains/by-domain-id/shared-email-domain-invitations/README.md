...
Lifecycle: `POST /domains/{domain-id}/sharedEmailDomainInvitations`, `GET/PATCH/DELETE /domains/{domain-id}/sharedEmailDomainInvitations/{sharedEmailDomainInvitation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/domains/by-domain-id/shared-email-domain-invitations"
...
| `invitation_domain` | `invitationDomain` | `string` | no | no |
| `invitation_status` | `invitationStatus` | `string` | no | no |
