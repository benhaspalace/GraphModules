...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/networkaccess-remotenetworkhealthevent?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /networkAccess/logs/remoteNetworks`, `GET/PATCH/DELETE /networkAccess/logs/remoteNetworks/{remoteNetworkHealthEvent-id}`.
