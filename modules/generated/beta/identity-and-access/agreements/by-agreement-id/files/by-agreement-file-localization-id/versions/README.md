...
Lifecycle: `POST /agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions`, `GET/PATCH/DELETE /agreements/{agreement-id}/files/{agreementFileLocalization-id}/versions/{agreementFileVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/agreements/by-agreement-id/files/by-agreement-file-localization-id/versions"
