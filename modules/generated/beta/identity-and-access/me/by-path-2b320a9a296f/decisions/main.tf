...
resource "msgraph_resource" "this" {
  url                     = "me/pendingAccessReviewInstances/${urlencode(var.access_review_instance_id)}/stages/${urlencode(var.access_review_stage_id)}/decisions/${urlencode(var.access_review_instance_decision_item_id)}/instance/decisions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
