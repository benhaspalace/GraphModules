...
Lifecycle: `POST /me/pendingAccessReviewInstances/{accessReviewInstance-id}/stages`, `GET/PATCH/DELETE /me/pendingAccessReviewInstances/{accessReviewInstance-id}/stages/{accessReviewStage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/me/pending-access-review-instances/by-access-review-instance-id/stages"
