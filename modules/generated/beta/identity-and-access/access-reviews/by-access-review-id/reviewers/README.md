...
Lifecycle: `POST /accessReviews/{accessReview-id}/reviewers`, `GET/PATCH/DELETE /accessReviews/{accessReview-id}/reviewers/{accessReviewReviewer-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/access-reviews/by-access-review-id/reviewers"
