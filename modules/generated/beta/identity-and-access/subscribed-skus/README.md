...
[Catalog](../../README.md) · [Identity and access](../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/subscribedsku?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /subscribedSkus`, `GET/PATCH/DELETE /subscribedSkus/{subscribedSku-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/subscribed-skus"
}
```
...
| `account_name` | `accountName` | `string` | no | no |
...
| `subscription_ids` | `subscriptionIds` | `list(string)` | no | no |
