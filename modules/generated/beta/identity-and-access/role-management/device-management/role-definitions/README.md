...
Lifecycle: `POST /roleManagement/deviceManagement/roleDefinitions`, `GET/PATCH/DELETE /roleManagement/deviceManagement/roleDefinitions/{unifiedRoleDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/device-management/role-definitions"
}
```
