...
Lifecycle: `POST /roleManagement/entitlementManagement/roleEligibilityScheduleInstances`, `GET/PATCH/DELETE /roleManagement/entitlementManagement/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/entitlement-management/role-eligibility-schedule-instances"
}
```
