...
locals {
  typed_body = { for key, value in {
    ...
    "roleEligibilityScheduleId" = var.role_eligibility_schedule_id
...
resource "msgraph_resource" "this" {
  url                     = "roleManagement/enterpriseApps/${urlencode(var.rbac_application_id)}/roleEligibilityScheduleInstances"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
