...
Lifecycle: `POST /roleManagement/directory/roleAssignmentSchedules`, `GET/PATCH/DELETE /roleManagement/directory/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/directory/role-assignment-schedules"
}
```
