...
Lifecycle: `POST /roleManagement/directory/roleEligibilitySchedules`, `GET/PATCH/DELETE /roleManagement/directory/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/directory/role-eligibility-schedules"
}
```
