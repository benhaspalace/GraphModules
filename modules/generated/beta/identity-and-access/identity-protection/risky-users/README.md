...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/riskyuser?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identityProtection/riskyUsers`, `GET/PATCH/DELETE /identityProtection/riskyUsers/{riskyUser-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-protection/risky-users"
}
```
