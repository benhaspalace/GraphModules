...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackageAssignments/${urlencode(var.access_package_assignment_id)}/accessPackage/accessPackageResourceRoleScopes/${urlencode(var.access_package_resource_role_scope_id)}/accessPackageResourceRole/accessPackageResource/uploadSessions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
