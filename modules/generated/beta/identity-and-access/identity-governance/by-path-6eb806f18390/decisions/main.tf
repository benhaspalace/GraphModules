...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/accessReviews/unified/definitions/${urlencode(var.access_review_schedule_definition_id)}/instances/${urlencode(var.access_review_instance_id)}/stages/${urlencode(var.access_review_stage_id)}/decisions/${urlencode(var.access_review_instance_decision_item_id)}/instance/decisions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
