...
Lifecycle: `POST /identityGovernance/entitlementManagement/assignmentRequests`, `GET/PATCH/DELETE /identityGovernance/entitlementManagement/assignmentRequests/{accessPackageAssignmentRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/entitlement-management/assignment-requests"
}
```
