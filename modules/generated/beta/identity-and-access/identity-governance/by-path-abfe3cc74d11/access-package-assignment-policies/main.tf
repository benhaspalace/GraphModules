...
locals {
  typed_body = { for key, value in {
    ...
    "accessPackageId"                   = var.access_package_id
...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackageAssignments/${urlencode(var.access_package_assignment_id)}/accessPackage/accessPackageAssignmentPolicies"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
