...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackages/test-parent-id/accessPackageResourceRoleScopes/test-parent-id/accessPackageResourceRole/accessPackageResource/uploadSessions"
