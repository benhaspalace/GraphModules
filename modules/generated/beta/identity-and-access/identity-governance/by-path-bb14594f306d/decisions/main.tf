...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/accessReviews/decisions/${urlencode(var.access_review_instance_decision_item_id)}/instance/stages/${urlencode(var.access_review_stage_id)}/decisions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
