...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackageResourceRoleScopes/${urlencode(var.access_package_resource_role_scope_id)}/accessPackageResourceScope/accessPackageResource/uploadSessions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
