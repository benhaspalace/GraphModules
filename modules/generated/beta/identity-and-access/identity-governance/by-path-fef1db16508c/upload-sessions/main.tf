...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/catalogs/${urlencode(var.access_package_catalog_id)}/accessPackageResources/${urlencode(var.access_package_resource_id)}/accessPackageResourceRoles/${urlencode(var.access_package_resource_role_id)}/accessPackageResource/uploadSessions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
