...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/accessReviews/unified/definitions/test-parent-id/instances/test-parent-id/decisions/test-parent-id/instance/contactedReviewers"
