...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackageAssignments/test-parent-id/accessPackage/accessPackageAssignmentPolicies/test-parent-id/customExtensionStageSettings"
...
run "invalid_enum" {
  ...
  variables {
    access_package_assignment_id        = "test-parent-id"
    access_package_assignment_policy_id = "test-parent-id"
    stage                               = "__graphmodules_invalid_enum__"
  }
