...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackages/test-parent-id/accessPackageAssignmentPolicies/test-parent-id/customExtensionStageSettings"
