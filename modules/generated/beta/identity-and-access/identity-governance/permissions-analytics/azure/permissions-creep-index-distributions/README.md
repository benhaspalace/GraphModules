...
[Catalog](../../../../../README.md) · [Identity and access](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/permissionscreepindexdistribution?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions`, `GET/PATCH/DELETE /identityGovernance/permissionsAnalytics/azure/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/permissions-analytics/azure/permissions-creep-index-distributions"
}
```
...
| `medium_risk_profile` | `mediumRiskProfile` | `object({       odata_type = optional(string, "#microsoft.graph.riskProfile")       humanCount = optional(number)       nonHumanCount = optional(number)     })` | no | no |
