...
Lifecycle: `POST /identityGovernance/permissionsAnalytics/azure/findings`, `GET/PATCH/DELETE /identityGovernance/permissionsAnalytics/azure/findings/{finding-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/permissions-analytics/azure/findings"
}
```
