...
Lifecycle: `POST /identityGovernance/permissionsAnalytics/gcp/permissionsCreepIndexDistributions`, `GET/PATCH/DELETE /identityGovernance/permissionsAnalytics/gcp/permissionsCreepIndexDistributions/{permissionsCreepIndexDistribution-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/permissions-analytics/gcp/permissions-creep-index-distributions"
}
```
