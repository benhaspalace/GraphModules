...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackageCatalogs/${urlencode(var.access_package_catalog_id)}/accessPackageResources/${urlencode(var.access_package_resource_id)}/accessPackageResourceScopes/${urlencode(var.access_package_resource_scope_id)}/accessPackageResource/uploadSessions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
