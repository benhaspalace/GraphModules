...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackageAssignments/${urlencode(var.access_package_assignment_id)}/accessPackageAssignmentResourceRoles/${urlencode(var.access_package_assignment_resource_role_id)}/accessPackageResourceScope/accessPackageResource/accessPackageResourceRoles/${urlencode(var.access_package_resource_role_id)}/accessPackageResource/uploadSessions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
