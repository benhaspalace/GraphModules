...
Lifecycle: `POST /policies/authenticationMethodsPolicy/authenticationMethodConfigurations`, `GET/PATCH/DELETE /policies/authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/policies/authentication-methods-policy/authentication-method-configurations"
}
```
