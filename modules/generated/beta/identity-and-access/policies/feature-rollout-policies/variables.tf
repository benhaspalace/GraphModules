...
variable "feature" {
  ...
  validation {
    condition     = var.feature == null ? true : contains(["passthroughAuthentication", "seamlessSso", "passwordHashSync", "emailAsAlternateId", "unknownFutureValue", "certificateBasedAuthentication"], var.feature)
