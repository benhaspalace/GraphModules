...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/delegatedadminrelationship?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /tenantRelationships/delegatedAdminRelationships`, `GET/PATCH/DELETE /tenantRelationships/delegatedAdminRelationships/{delegatedAdminRelationship-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/tenant-relationships/delegated-admin-relationships"
}
```
...
| `operations` | `operations` | `list(object({       odata_type = optional(string, "#microsoft.graph.delegatedAdminRelationshipOperation")       operationType = optional(string)       status = optional(string)     }))` | no | no |
| `requests` | `requests` | `list(object({       odata_type = optional(string, "#microsoft.graph.delegatedAdminRelationshipRequest")       action = optional(string)     }))` | no | no |
