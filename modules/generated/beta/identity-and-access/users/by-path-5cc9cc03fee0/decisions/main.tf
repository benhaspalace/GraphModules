...
resource "msgraph_resource" "this" {
  url                     = "users/${urlencode(var.user_id)}/pendingAccessReviewInstances/${urlencode(var.access_review_instance_id)}/stages/${urlencode(var.access_review_stage_id)}/decisions"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
