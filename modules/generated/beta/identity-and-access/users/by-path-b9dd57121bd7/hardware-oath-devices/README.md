...
Lifecycle: `POST /users/{user-id}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod-id}/device/hardwareOathDevices`, `GET/PATCH/DELETE /users/{user-id}/authentication/hardwareOathMethods/{hardwareOathAuthenticationMethod-id}/device/hardwareOathDevices/{hardwareOathTokenAuthenticationMethodDevice-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/users/by-path-b9dd57121bd7/hardware-oath-devices"
...
| `hardware_oath_authentication_method_id` | URL parameter `hardwareOathAuthenticationMethod-id` | `string` | yes | no |
