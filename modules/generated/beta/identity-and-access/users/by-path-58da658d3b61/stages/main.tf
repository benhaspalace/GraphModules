...
resource "msgraph_resource" "this" {
  url                     = "users/${urlencode(var.user_id)}/pendingAccessReviewInstances/${urlencode(var.access_review_instance_id)}/decisions/${urlencode(var.access_review_instance_decision_item_id)}/instance/stages"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
