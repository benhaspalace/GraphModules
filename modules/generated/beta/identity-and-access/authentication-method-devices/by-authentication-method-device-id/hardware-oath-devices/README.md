...
Lifecycle: `POST /authenticationMethodDevices/{authenticationMethodDevice-id}/hardwareOathDevices`, `GET/PATCH/DELETE /authenticationMethodDevices/{authenticationMethodDevice-id}/hardwareOathDevices/{hardwareOathTokenAuthenticationMethodDevice-id}`.
...
| --- | --- | --- | --- | --- |
| `authentication_method_device_id` | URL parameter `authenticationMethodDevice-id` | `string` | yes | no |
