...
Lifecycle: `POST /authenticationMethodDevices`, `GET/PATCH/DELETE /authenticationMethodDevices/{authenticationMethodDevice-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/authentication-method-devices"
}
```
