...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/webapplicationfirewallverificationmodel?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identity/riskPrevention/webApplicationFirewallVerifications`, `GET/PATCH/DELETE /identity/riskPrevention/webApplicationFirewallVerifications/{webApplicationFirewallVerificationModel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity/risk-prevention/web-application-firewall-verifications"
}
```
