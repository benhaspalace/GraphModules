...
Lifecycle: `POST /privilegedRoleAssignmentRequests`, `GET/PATCH/DELETE /privilegedRoleAssignmentRequests/{privilegedRoleAssignmentRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-role-assignment-requests"
}
```
