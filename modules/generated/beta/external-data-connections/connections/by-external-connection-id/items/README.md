...
[Catalog](../../../../README.md) · [External data connections](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/externalconnectors-externalitem?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /connections/{externalConnection-id}/items`, `GET/PUT/DELETE /connections/{externalConnection-id}/items/{externalItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./external-data-connections/connections/by-external-connection-id/items"
