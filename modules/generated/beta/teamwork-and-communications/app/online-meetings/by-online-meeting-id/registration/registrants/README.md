...
Lifecycle: `POST /app/onlineMeetings/{onlineMeeting-id}/registration/registrants`, `GET/PATCH/DELETE /app/onlineMeetings/{onlineMeeting-id}/registration/registrants/{meetingRegistrantBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/app/online-meetings/by-online-meeting-id/registration/registrants"
