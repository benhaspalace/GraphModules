...
Lifecycle: `POST /teams/{team-id}/primaryChannel/sharedWithTeams`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/primary-channel/shared-with-teams"
