...
Lifecycle: `POST /teams/{team-id}/schedule/timeOffRequests`, `GET/PATCH/DELETE /teams/{team-id}/schedule/timeOffRequests/{timeOffRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/schedule/time-off-requests"
