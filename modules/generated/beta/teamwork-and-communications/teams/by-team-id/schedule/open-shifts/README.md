...
Lifecycle: `POST /teams/{team-id}/schedule/openShifts`, `GET/PATCH/DELETE /teams/{team-id}/schedule/openShifts/{openShift-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/schedule/open-shifts"
