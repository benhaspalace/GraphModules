...
Lifecycle: `POST /teams/{team-id}/schedule/timesOff`, `GET/PATCH/DELETE /teams/{team-id}/schedule/timesOff/{timeOff-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/schedule/times-off"
