...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/messages/{chatMessage-id}/hostedContents`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/messages/by-chat-message-id/hosted-contents"
