...
Lifecycle: `POST /groups/{group-id}/team/schedule/timesOff`, `GET/PATCH/DELETE /groups/{group-id}/team/schedule/timesOff/{timeOff-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/schedule/times-off"
