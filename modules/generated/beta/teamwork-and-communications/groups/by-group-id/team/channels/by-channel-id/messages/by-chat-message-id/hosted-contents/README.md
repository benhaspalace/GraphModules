...
Lifecycle: `POST /groups/{group-id}/team/channels/{channel-id}/messages/{chatMessage-id}/hostedContents`, `GET/PATCH/DELETE /groups/{group-id}/team/channels/{channel-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/channels/by-channel-id/messages/by-chat-message-id/hosted-contents"
