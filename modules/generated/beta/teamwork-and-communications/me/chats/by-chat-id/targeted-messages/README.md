# /me/chats/{chat-id}/targetedMessages
...
Lifecycle: `POST /me/chats/{chat-id}/targetedMessages`, `GET/PATCH/DELETE /me/chats/{chat-id}/targetedMessages/{targetedChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/chats/by-chat-id/targeted-messages"
