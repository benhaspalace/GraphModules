...
Lifecycle: `POST /me/chats/{chat-id}/operations`, `GET/PATCH/DELETE /me/chats/{chat-id}/operations/{teamsAsyncOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/chats/by-chat-id/operations"
