...
Lifecycle: `POST /teamTemplateDefinition`, `GET/PATCH/DELETE /teamTemplateDefinition/{teamTemplateDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/team-template-definition"
}
```
