...
resource "msgraph_resource" "this" {
  url                     = "teamwork/teamTemplates/${urlencode(var.team_template_id)}/definitions/${urlencode(var.team_template_definition_id)}/teamDefinition/schedule/swapShiftsChangeRequests"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
