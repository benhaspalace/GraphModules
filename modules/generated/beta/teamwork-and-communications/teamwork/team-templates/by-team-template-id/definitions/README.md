...
Lifecycle: `POST /teamwork/teamTemplates/{teamTemplate-id}/definitions`, `GET/PATCH/DELETE /teamwork/teamTemplates/{teamTemplate-id}/definitions/{teamTemplateDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teamwork/team-templates/by-team-template-id/definitions"
