...
Lifecycle: `POST /communications/onlineMeetings`, `GET/PATCH/DELETE /communications/onlineMeetings/{onlineMeeting-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/communications/online-meetings"
}
```
...
- registration: polymorphic schema; accepts an untyped value
