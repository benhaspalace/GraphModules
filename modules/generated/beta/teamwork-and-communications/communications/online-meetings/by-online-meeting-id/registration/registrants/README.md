...
Lifecycle: `POST /communications/onlineMeetings/{onlineMeeting-id}/registration/registrants`, `GET/PATCH/DELETE /communications/onlineMeetings/{onlineMeeting-id}/registration/registrants/{meetingRegistrantBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/communications/online-meetings/by-online-meeting-id/registration/registrants"
