...
Lifecycle: `POST /communications/calls/{call-id}/operations`, `GET/PATCH/DELETE /communications/calls/{call-id}/operations/{commsOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/communications/calls/by-call-id/operations"
