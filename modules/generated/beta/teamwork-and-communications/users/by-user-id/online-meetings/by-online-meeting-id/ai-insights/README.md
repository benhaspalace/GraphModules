...
Lifecycle: `POST /users/{user-id}/onlineMeetings/{onlineMeeting-id}/aiInsights`, `GET/PATCH/DELETE /users/{user-id}/onlineMeetings/{onlineMeeting-id}/aiInsights/{callAiInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/online-meetings/by-online-meeting-id/ai-insights"
