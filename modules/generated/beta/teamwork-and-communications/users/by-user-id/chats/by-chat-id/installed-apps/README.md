...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/installedApps`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/installed-apps"
