...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/hostedContents`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/hostedContents/{chatMessageHostedContent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/targeted-messages/by-targeted-chat-message-id/hosted-contents"
