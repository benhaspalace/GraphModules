...
resource "msgraph_resource" "this" {
  url                     = "users/${urlencode(var.user_id)}/onlineMeetings/${urlencode(var.online_meeting_id)}/attendanceReports/${urlencode(var.meeting_attendance_report_id)}/attendanceRecords"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
