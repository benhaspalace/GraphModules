...
Lifecycle: `POST /solutions/virtualEvents/webinars/{virtualEventWebinar-id}/presenters`, `GET/PATCH/DELETE /solutions/virtualEvents/webinars/{virtualEventWebinar-id}/presenters/{virtualEventPresenter-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/solutions/virtual-events/webinars/by-virtual-event-webinar-id/presenters"
