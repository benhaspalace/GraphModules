...
Lifecycle: `POST /chats/{chat-id}/installedApps`, `GET/PATCH/DELETE /chats/{chat-id}/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/installed-apps"
