...
Lifecycle: `POST /chats/{chat-id}/targetedMessages`, `GET/PATCH/DELETE /chats/{chat-id}/targetedMessages/{targetedChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/targeted-messages"
