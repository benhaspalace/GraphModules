...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "me/pendingAccessReviewInstances/test-parent-id/stages/test-parent-id/decisions/test-parent-id/instance/decisions/test-parent-id/insights"
