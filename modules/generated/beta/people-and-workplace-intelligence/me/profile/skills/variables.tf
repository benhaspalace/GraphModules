...
variable "proficiency" {
  description = "Detail of the users proficiency with this skill. The possible values are: elementary, limitedWorking, generalProfessional, advancedProfessional, expert, unknownFutureValue."
  type        = any
  default     = null

  validation {
    condition     = var.proficiency == null ? true : contains(["elementary", "limitedWorking", "generalProfessional", "advancedProfessional", "expert", "unknownFutureValue"], var.proficiency)
