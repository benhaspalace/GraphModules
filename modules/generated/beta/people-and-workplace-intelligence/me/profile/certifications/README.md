...
Lifecycle: `POST /me/profile/certifications`, `GET/PATCH/DELETE /me/profile/certifications/{personCertification-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/certifications"
}
```
