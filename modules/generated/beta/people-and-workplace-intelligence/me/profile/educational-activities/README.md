...
Lifecycle: `POST /me/profile/educationalActivities`, `GET/PATCH/DELETE /me/profile/educationalActivities/{educationalActivity-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/educational-activities"
}
```
