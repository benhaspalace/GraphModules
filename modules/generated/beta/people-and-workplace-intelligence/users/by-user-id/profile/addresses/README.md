...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/itemaddress?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/addresses`, `GET/PATCH/DELETE /users/{user-id}/profile/addresses/{itemAddress-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/addresses"
...
| `geo_coordinates` | `geoCoordinates` | `any` | no | no |
...
- geoCoordinates: polymorphic schema; accepts an untyped value
