# /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/insights
...
Lifecycle: `POST /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/insights`, `GET/PATCH/DELETE /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/insights/{governanceInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/identity-governance/by-path-f1823aed4470/insights"
