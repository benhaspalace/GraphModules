...
Lifecycle: `POST /identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem-id}/insights`, `GET/PATCH/DELETE /identityGovernance/accessReviews/decisions/{accessReviewInstanceDecisionItem-id}/insights/{governanceInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/identity-governance/access-reviews/decisions/by-access-review-instance-decision-item-id/insights"
