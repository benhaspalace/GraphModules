...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/contentTypes`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/contentTypes/{contentType-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/content-types"
