...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/relations/{relation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/term-store/sets/by-set-id/terms/by-term-id/relations"
