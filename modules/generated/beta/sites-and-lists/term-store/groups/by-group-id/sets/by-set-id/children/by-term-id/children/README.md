...
Lifecycle: `POST /termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children`, `GET/PATCH/DELETE /termStore/groups/{group-id}/sets/{set-id}/children/{term-id}/children/{term-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/groups/by-group-id/sets/by-set-id/children/by-term-id/children"
