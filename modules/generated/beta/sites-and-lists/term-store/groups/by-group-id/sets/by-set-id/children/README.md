...
Lifecycle: `POST /termStore/groups/{group-id}/sets/{set-id}/children`, `GET/PATCH/DELETE /termStore/groups/{group-id}/sets/{set-id}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/groups/by-group-id/sets/by-set-id/children"
