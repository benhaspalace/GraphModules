# /termStore/sets/{set-id}/children
...
Lifecycle: `POST /termStore/sets/{set-id}/children`, `GET/PATCH/DELETE /termStore/sets/{set-id}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/sets/by-set-id/children"
