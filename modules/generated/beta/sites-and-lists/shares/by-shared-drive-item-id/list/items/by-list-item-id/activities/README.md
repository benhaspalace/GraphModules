...
Lifecycle: `POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/items/by-list-item-id/activities"
