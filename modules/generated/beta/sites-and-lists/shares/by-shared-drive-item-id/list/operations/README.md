...
Lifecycle: `POST /shares/{sharedDriveItem-id}/list/operations`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/operations/{richLongRunningOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/operations"
