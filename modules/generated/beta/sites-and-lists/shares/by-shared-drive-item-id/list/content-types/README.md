...
[Catalog](../../../../../README.md) · [Sites and lists](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/contenttype?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /shares/{sharedDriveItem-id}/list/contentTypes`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/content-types"
...
- baseTypes[].columnPositions[].sourceContentType: polymorphic schema; accepts an untyped value
...
- baseTypes[].columns[].sourceContentType: polymorphic schema; accepts an untyped value
...
- columnPositions[].sourceContentType: polymorphic schema; accepts an untyped value
