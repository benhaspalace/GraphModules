...
Lifecycle: `POST /drives/{drive-id}/list/operations`, `GET/PATCH/DELETE /drives/{drive-id}/list/operations/{richLongRunningOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/drives/by-drive-id/list/operations"
