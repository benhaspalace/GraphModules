...
Lifecycle: `POST /drives/{drive-id}/list/contentTypes/{contentType-id}/columns`, `GET/PATCH/DELETE /drives/{drive-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/drives/by-drive-id/list/content-types/by-content-type-id/columns"
