...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/operations`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/operations/{richLongRunningOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/lists/by-list-id/operations"
