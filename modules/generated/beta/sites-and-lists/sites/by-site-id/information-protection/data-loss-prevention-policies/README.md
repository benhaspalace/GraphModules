...
Lifecycle: `POST /sites/{site-id}/informationProtection/dataLossPreventionPolicies`, `GET/PATCH/DELETE /sites/{site-id}/informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/information-protection/data-loss-prevention-policies"
