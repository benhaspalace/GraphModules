...
Lifecycle: `POST /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/terms`, `GET/PATCH/DELETE /sites/{site-id}/termStore/groups/{group-id}/sets/{set-id}/terms/{term-id}`.
