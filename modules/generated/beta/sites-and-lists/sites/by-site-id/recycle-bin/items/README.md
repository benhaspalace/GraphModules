...
Lifecycle: `POST /sites/{site-id}/recycleBin/items`, `GET/PATCH/DELETE /sites/{site-id}/recycleBin/items/{recycleBinItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/recycle-bin/items"
