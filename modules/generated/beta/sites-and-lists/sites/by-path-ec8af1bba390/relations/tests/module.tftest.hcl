...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "sites/test-parent-id/termStore/sets/test-parent-id/parentGroup/sets/test-parent-id/terms/test-parent-id/children/test-parent-id/relations"
