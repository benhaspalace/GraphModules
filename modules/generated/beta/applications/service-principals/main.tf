...
locals {
  typed_body = { for key, value in {
    ...
    "claimsPolicy"                        = var.claims_policy
    ...
    "endpoints"                           = (var.endpoints == null ? null : [for item0 in var.endpoints : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "deletedDateTime" = item0["deletedDateTime"] } : key1 => value1 if value1 != null }) if item0 != null])
    "errorUrl"                            = var.error_url
    ...
    "licenseDetails"                      = (var.license_details == null ? null : [for item0 in var.license_details : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"] } : key1 => value1 if value1 != null }) if item0 != null])
    ...
    "permissionGrantPreApprovalPolicies"  = (var.permission_grant_pre_approval_policies == null ? null : [for item0 in var.permission_grant_pre_approval_policies : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "conditions" = (item0["conditions"] == null ? null : [for item2 in item0["conditions"] : (item2 == null ? null : { for key3, value3 in { "@odata.type" = item2["odata_type"], "permissions" = (item2["permissions"] == null ? null : { for key4, value4 in { "@odata.type" = item2["permissions"]["odata_type"], "permissionKind" = item2["permissions"]["permissionKind"], "permissionType" = item2["permissions"]["permissionType"] } : key4 => value4 if value4 != null }), "scopeType" = item2["scopeType"], "sensitivityLabels" = (item2["sensitivityLabels"] == null ? null : { for key4, value4 in { "@odata.type" = item2["sensitivityLabels"]["odata_type"], "labelKind" = item2["sensitivityLabels"]["labelKind"] } : key4 => value4 if value4 != null }) } : key3 => value3 if value3 != null }) if item2 != null]), "deletedDateTime" = item0["deletedDateTime"] } : key1 => value1 if value1 != null }) if item0 != null])
    "preferredSingleSignOnMode"           = var.preferred_single_sign_on_mode
    "preferredTokenSigningKeyEndDateTime" = var.preferred_token_signing_key_end_date_time
    "preferredTokenSigningKeyThumbprint"  = var.preferred_token_signing_key_thumbprint
    "publishedPermissionScopes"           = (var.published_permission_scopes == null ? null : [for item0 in var.published_permission_scopes : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "adminConsentDescription" = item0["adminConsentDescription"], "adminConsentDisplayName" = item0["adminConsentDisplayName"], "id" = item0["id"], "isEnabled" = item0["isEnabled"], "origin" = item0["origin"], "type" = item0["type"], "userConsentDescription" = item0["userConsentDescription"], "userConsentDisplayName" = item0["userConsentDisplayName"], "value" = item0["value"] } : key1 => value1 if value1 != null }) if item0 != null])
