...
Lifecycle: `POST /applications/{application-id}/synchronization/jobs/{synchronizationJob-id}/schema/directories`, `GET/PATCH/DELETE /applications/{application-id}/synchronization/jobs/{synchronizationJob-id}/schema/directories/{directoryDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./applications/applications/by-application-id/synchronization/jobs/by-synchronization-job-id/schema/directories"
  application_id = "parent-object-id"
  synchronization_job_id = "parent-object-id"
}
```
...
| `synchronization_job_id` | URL parameter `synchronizationJob-id` | `string` | yes | no |
