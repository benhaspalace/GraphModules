...
Lifecycle: `POST /dataClassification/evaluateLabelJobs`, `GET/PATCH/DELETE /dataClassification/evaluateLabelJobs/{jobResponseBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/evaluate-label-jobs"
}
```
