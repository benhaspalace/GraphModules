...
Lifecycle: `POST /dataClassification/sensitiveTypes`, `GET/PATCH/DELETE /dataClassification/sensitiveTypes/{sensitiveType-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/sensitive-types"
}
```
