...
Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/legalHolds/{legalHold-id}/siteSources`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/legalHolds/{legalHold-id}/siteSources/{siteSource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/legal-holds/by-legal-hold-id/site-sources"
