...
resource "msgraph_resource" "this" {
  url                     = "compliance/ediscovery/cases/${urlencode(var.case_id)}/sourceCollections"
  api_version             = "beta"
  update_method           = "PATCH"
  body                    = local.body
