...
Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/custodians/{custodian-id}/userSources`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/custodians/{custodian-id}/userSources/{userSource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/custodians/by-custodian-id/user-sources"
