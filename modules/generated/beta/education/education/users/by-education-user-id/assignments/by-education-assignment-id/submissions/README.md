...
Lifecycle: `POST /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions`, `GET/PATCH/DELETE /education/users/{educationUser-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./education/education/users/by-education-user-id/assignments/by-education-assignment-id/submissions"
