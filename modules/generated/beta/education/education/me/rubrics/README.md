...
[Catalog](../../../../README.md) · [Education](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/educationrubric?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /education/me/rubrics`, `GET/PATCH/DELETE /education/me/rubrics/{educationRubric-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./education/education/me/rubrics"
}
```
