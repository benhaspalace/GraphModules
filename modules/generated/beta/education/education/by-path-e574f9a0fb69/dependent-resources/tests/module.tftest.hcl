...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "education/users/test-parent-id/assignments/test-parent-id/submissions/test-parent-id/resources/test-parent-id/dependentResources"
