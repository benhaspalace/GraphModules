...
[Catalog](../../../../../../../README.md) · [Education](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/educationsubmission?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions`, `GET/PATCH/DELETE /education/classes/{educationClass-id}/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./education/education/classes/by-education-class-id/assignments/by-education-assignment-id/submissions"
...
- submittedResources[].dependentResources[]: recursive schema; accepts an untyped value
- submittedResources[].resource: polymorphic schema; accepts an untyped value
