...
locals {
  typed_body = { for key, value in {
    ...
    "error"                                    = var.error
    "granularSiteRestoreArtifacts"             = (var.granular_site_restore_artifacts == null ? null : [for item0 in var.granular_site_restore_artifacts : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "browseSessionId" = item0["browseSessionId"], "completionDateTime" = item0["completionDateTime"], "restorePointDateTime" = item0["restorePointDateTime"], "restoredItemKey" = item0["restoredItemKey"], "restoredItemPath" = item0["restoredItemPath"], "restoredItemWebUrl" = item0["restoredItemWebUrl"], "siteId" = item0["siteId"], "startDateTime" = item0["startDateTime"], "status" = item0["status"], "webUrl" = item0["webUrl"] } : key1 => value1 if value1 != null }) if item0 != null])
