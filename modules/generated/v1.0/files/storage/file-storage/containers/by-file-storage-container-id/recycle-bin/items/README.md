...
[Catalog](../../../../../../../README.md) · [Files](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/recyclebinitem?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /storage/fileStorage/containers/{fileStorageContainer-id}/recycleBin/items`, `GET/PATCH/DELETE /storage/fileStorage/containers/{fileStorageContainer-id}/recycleBin/items/{recycleBinItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./files/storage/file-storage/containers/by-file-storage-container-id/recycle-bin/items"
