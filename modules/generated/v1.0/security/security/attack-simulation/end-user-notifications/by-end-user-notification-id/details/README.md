...
Lifecycle: `POST /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details`, `GET/PATCH/DELETE /security/attackSimulation/endUserNotifications/{endUserNotification-id}/details/{endUserNotificationDetail-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/attack-simulation/end-user-notifications/by-end-user-notification-id/details"
  end_user_notification_id = "parent-object-id"
}
```
...
| --- | --- | --- | --- | --- |
| `end_user_notification_id` | URL parameter `endUserNotification-id` | `string` | yes | no |
| `email_content` | `emailContent` | `string` | no | no |
