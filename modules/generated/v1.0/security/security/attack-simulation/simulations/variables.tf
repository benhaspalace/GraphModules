variable "attack_technique" {
  ...
  validation {
    condition     = var.attack_technique == null ? true : contains(["unknown", "credentialHarvesting", "attachmentMalware", "driveByUrl", "linkInAttachment", "linkToMalwareFile", "unknownFutureValue"], var.attack_technique)
...
variable "status" {
  description = "Status of the attack simulation and training campaign. Supports $filter and $orderby. The possible values are: unknown, draft, running, scheduled, succeeded, failed, canceled, excluded, unknownFutureValue."
  type        = any
  default     = null
