...
[Catalog](../../../../../README.md) · [Security](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/contentactivity?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /me/dataSecurityAndGovernance/activities/contentActivities`, `GET/PATCH/DELETE /me/dataSecurityAndGovernance/activities/contentActivities/{contentActivity-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/me/data-security-and-governance/activities/content-activities"
}
```
