...
Lifecycle: `POST /users/{user-id}/planner/plans/{plannerPlan-id}/tasks`, `GET/PATCH/DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/users/by-user-id/planner/plans/by-planner-plan-id/tasks"
