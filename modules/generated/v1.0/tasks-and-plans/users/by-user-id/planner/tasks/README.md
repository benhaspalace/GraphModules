...
Lifecycle: `POST /users/{user-id}/planner/tasks`, `GET/PATCH/DELETE /users/{user-id}/planner/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/users/by-user-id/planner/tasks"
