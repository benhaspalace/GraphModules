...
Lifecycle: `POST /me/planner/plans/{plannerPlan-id}/tasks`, `GET/PATCH/DELETE /me/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/me/planner/plans/by-planner-plan-id/tasks"
