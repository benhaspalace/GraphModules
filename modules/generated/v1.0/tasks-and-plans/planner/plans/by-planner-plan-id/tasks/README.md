...
Lifecycle: `POST /planner/plans/{plannerPlan-id}/tasks`, `GET/PATCH/DELETE /planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/planner/plans/by-planner-plan-id/tasks"
