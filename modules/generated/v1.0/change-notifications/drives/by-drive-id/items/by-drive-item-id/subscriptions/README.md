...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/subscriptions`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/subscriptions/{subscription-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./change-notifications/drives/by-drive-id/items/by-drive-item-id/subscriptions"
