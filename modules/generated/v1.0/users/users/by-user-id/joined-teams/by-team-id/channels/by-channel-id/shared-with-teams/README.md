...
Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/channels/{channel-id}/sharedWithTeams`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/channels/{channel-id}/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/users/by-user-id/joined-teams/by-team-id/channels/by-channel-id/shared-with-teams"
