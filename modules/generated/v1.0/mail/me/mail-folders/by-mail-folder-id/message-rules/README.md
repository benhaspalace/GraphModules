...
Lifecycle: `POST /me/mailFolders/{mailFolder-id}/messageRules`, `GET/PATCH/DELETE /me/mailFolders/{mailFolder-id}/messageRules/{messageRule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./mail/me/mail-folders/by-mail-folder-id/message-rules"
