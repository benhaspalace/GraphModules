...
Lifecycle: `POST /storage/fileStorage/containers/{fileStorageContainer-id}/columns`, `GET/PATCH/DELETE /storage/fileStorage/containers/{fileStorageContainer-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/storage/file-storage/containers/by-file-storage-container-id/columns"
