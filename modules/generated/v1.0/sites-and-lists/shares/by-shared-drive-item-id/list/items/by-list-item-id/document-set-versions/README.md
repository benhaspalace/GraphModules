...
[Catalog](../../../../../../../README.md) · [Sites and lists](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/documentsetversion?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/items/by-list-item-id/document-set-versions"
