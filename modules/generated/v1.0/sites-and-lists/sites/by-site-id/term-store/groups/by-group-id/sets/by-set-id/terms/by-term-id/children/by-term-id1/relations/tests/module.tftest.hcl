...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "sites/test-parent-id/termStore/groups/test-parent-id/sets/test-parent-id/terms/test-parent-id/children/test-parent-id/relations"
