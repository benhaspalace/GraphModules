...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/lists/by-list-id/items/by-list-item-id/document-set-versions"
