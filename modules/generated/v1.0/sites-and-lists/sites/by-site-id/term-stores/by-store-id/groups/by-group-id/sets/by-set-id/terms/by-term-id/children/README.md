...
Lifecycle: `POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/terms/{term-id}/children`, `GET/PATCH/DELETE /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/terms/{term-id}/children/{term-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-stores/by-store-id/groups/by-group-id/sets/by-set-id/terms/by-term-id/children"
