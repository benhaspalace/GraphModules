...
Lifecycle: `POST /sites/{site-id}/termStores/{store-id}/sets/{set-id}/children/{term-id}/children`, `GET/PATCH/DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/children/{term-id}/children/{term-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-stores/by-store-id/sets/by-set-id/children/by-term-id/children"
