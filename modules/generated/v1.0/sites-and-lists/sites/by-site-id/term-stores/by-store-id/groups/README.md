...
Lifecycle: `POST /sites/{site-id}/termStores/{store-id}/groups`, `GET/PATCH/DELETE /sites/{site-id}/termStores/{store-id}/groups/{group-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-stores/by-store-id/groups"
