...
Lifecycle: `POST /sites/{site-id}/contentTypes/{contentType-id}/columns`, `GET/PATCH/DELETE /sites/{site-id}/contentTypes/{contentType-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/content-types/by-content-type-id/columns"
