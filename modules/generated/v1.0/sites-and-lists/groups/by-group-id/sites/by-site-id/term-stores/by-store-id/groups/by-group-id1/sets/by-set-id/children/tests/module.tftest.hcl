...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "groups/test-parent-id/sites/test-parent-id/termStores/test-parent-id/groups/test-parent-id/sets/test-parent-id/children"
