...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/lists/{list-id}/items/{listItem-id}/versions/{listItemVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/lists/by-list-id/items/by-list-item-id/versions"
