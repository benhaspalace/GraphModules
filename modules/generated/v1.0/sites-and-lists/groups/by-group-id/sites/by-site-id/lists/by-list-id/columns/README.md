...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/columns`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/lists/{list-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/lists/by-list-id/columns"
