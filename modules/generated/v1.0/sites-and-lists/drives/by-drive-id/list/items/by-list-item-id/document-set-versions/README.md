...
Lifecycle: `POST /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions`, `GET/PATCH/DELETE /drives/{drive-id}/list/items/{listItem-id}/documentSetVersions/{documentSetVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/drives/by-drive-id/list/items/by-list-item-id/document-set-versions"
