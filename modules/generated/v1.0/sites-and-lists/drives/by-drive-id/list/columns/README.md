...
Lifecycle: `POST /drives/{drive-id}/list/columns`, `GET/PATCH/DELETE /drives/{drive-id}/list/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/drives/by-drive-id/list/columns"
