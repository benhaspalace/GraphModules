...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["accountEnabled", "assignedLicenses", "assignments", "businessPhones", "classes", "createdBy", "department", "displayName", "externalSource", "externalSourceDetail", "givenName", "mailNickname", "mailingAddress", "middleName", "mobilePhone", "officeLocation", "onPremisesInfo", "passwordPolicies", "passwordProfile", "preferredLanguage", "primaryRole", "residenceAddress", "rubrics", "schools", "showInAddressList", "student", "surname", "taughtClasses", "teacher", "usageLocation", "user", "userPrincipalName", "userType"] : !contains(keys(msgraph_resource.this.body), key)])
