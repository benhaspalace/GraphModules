...
run "minimal_request" {
  ...
  variables {
    ...
    education_assignment_resource_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "education/classes/test-parent-id/assignments/test-parent-id/resources/test-parent-id/dependentResources"
