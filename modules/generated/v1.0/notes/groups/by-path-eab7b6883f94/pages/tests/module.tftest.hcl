...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "groups/test-parent-id/sites/test-parent-id/onenote/notebooks/test-parent-id/sectionGroups/test-parent-id/sections/test-parent-id/pages"
