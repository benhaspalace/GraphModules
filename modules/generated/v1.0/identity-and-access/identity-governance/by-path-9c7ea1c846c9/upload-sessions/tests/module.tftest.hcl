...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceRequests/test-parent-id/catalog/resources/test-parent-id/scopes/test-parent-id/resource/roles/test-parent-id/resource/uploadSessions"
