...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackages/${urlencode(var.access_package_id)}/assignmentPolicies/${urlencode(var.access_package_assignment_policy_id)}/questions"
  api_version             = "v1.0"
  update_method           = "PATCH"
  body                    = local.body
