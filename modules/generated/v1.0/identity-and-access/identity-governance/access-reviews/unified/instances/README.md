# /identityGovernance/accessReviews/unified/instances
...
Lifecycle: `POST /identityGovernance/accessReviews/unified/instances`, `GET/PATCH/DELETE /identityGovernance/accessReviews/unified/instances/{accessReviewInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/access-reviews/unified/instances"
}
```
