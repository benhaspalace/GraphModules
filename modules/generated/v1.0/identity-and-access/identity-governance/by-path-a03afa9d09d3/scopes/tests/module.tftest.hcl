...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceRequests/test-parent-id/catalog/resources/test-parent-id/roles/test-parent-id/resource/scopes"
