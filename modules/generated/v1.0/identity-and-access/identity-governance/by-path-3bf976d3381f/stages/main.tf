...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/accessReviews/unified/definitions/${urlencode(var.access_review_schedule_definition_id)}/instances/${urlencode(var.access_review_instance_id)}/stages"
  api_version             = "v1.0"
  update_method           = "PATCH"
  body                    = local.body
