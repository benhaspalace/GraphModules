...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/catalogs/test-parent-id/resources/test-parent-id/roles/test-parent-id/resource/uploadSessions"
