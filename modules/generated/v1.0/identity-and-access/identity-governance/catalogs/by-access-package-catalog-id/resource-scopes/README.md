# /identityGovernance/catalogs/{accessPackageCatalog-id}/resourceScopes
...
Lifecycle: `POST /identityGovernance/catalogs/{accessPackageCatalog-id}/resourceScopes`, `GET/PATCH/DELETE /identityGovernance/catalogs/{accessPackageCatalog-id}/resourceScopes/{accessPackageResourceScope-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/catalogs/by-access-package-catalog-id/resource-scopes"
