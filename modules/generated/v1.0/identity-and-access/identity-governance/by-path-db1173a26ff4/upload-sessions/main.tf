...
resource "msgraph_resource" "this" {
  url                     = "identityGovernance/entitlementManagement/accessPackages/${urlencode(var.access_package_id)}/resourceRoleScopes/${urlencode(var.access_package_resource_role_scope_id)}/role/resource/scopes/${urlencode(var.access_package_resource_scope_id)}/resource/uploadSessions"
  api_version             = "v1.0"
  update_method           = "PATCH"
  body                    = local.body
