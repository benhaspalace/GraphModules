...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["assignedPlans", "branding", "businessPhones", "certificateBasedAuthConfiguration", "city", "country", "countryLetterCode", "defaultUsageLocation", "deletedDateTime", "displayName", "marketingNotificationEmails", "mobileDeviceManagementAuthority", "onPremisesSyncEnabled", "partnerTenantType", "postalCode", "preferredLanguage", "privacyProfile", "provisionedPlans", "securityComplianceNotificationMails", "securityComplianceNotificationPhones", "state", "street", "technicalNotificationMails", "tenantType", "verifiedDomains"] : !contains(keys(msgraph_resource.this.body), key)])
...
run "invalid_enum" {
  ...
  variables {
    mobile_device_management_authority = "__graphmodules_invalid_enum__"
  }
