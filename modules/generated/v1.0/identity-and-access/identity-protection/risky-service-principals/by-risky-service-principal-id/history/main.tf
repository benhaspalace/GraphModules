...
locals {
  typed_body = { for key, value in {
    ...
    "history"                 = (var.history == null ? null : [for item0 in var.history : (item0 == null ? null : { for key1, value1 in { "@odata.type" = item0["odata_type"], "activity" = item0["activity"], "appId" = item0["appId"], "displayName" = item0["displayName"], "history" = (item0["history"] == null ? null : [for item2 in item0["history"] : item2 if item2 != null]), "initiatedBy" = item0["initiatedBy"], "isEnabled" = item0["isEnabled"], "isProcessing" = item0["isProcessing"], "riskDetail" = item0["riskDetail"], "riskLastUpdatedDateTime" = item0["riskLastUpdatedDateTime"], "riskLevel" = item0["riskLevel"], "riskState" = item0["riskState"], "servicePrincipalType" = item0["servicePrincipalType"] } : key1 => value1 if value1 != null }) if item0 != null])
