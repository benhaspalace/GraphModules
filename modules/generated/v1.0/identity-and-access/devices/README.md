...
[Catalog](../../README.md) · [Identity and access](../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/device?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /devices`, `GET/PATCH/DELETE /devices/{device-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/devices"
}
```
