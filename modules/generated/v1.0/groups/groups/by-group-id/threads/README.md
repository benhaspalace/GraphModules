...
[Catalog](../../../../README.md) · [Groups](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/groups-overview?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /groups/{group-id}/threads`, `GET/PATCH/DELETE /groups/{group-id}/threads/{conversationThread-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./groups/groups/by-group-id/threads"
