...
Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/primaryChannel/messages`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/primaryChannel/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/joined-teams/by-team-id/primary-channel/messages"
