...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/members`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/members/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/members"
