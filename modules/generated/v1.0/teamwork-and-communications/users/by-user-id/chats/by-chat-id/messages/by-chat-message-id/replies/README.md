...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/messages/by-chat-message-id/replies"
