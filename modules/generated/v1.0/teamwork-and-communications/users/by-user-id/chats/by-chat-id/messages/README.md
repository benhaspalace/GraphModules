...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/messages`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/messages"
