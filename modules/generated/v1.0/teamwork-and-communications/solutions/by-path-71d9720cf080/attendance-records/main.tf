...
resource "msgraph_resource" "this" {
  url                     = "solutions/virtualEvents/townhalls/${urlencode(var.virtual_event_townhall_id)}/sessions/${urlencode(var.virtual_event_session_id)}/attendanceReports/${urlencode(var.meeting_attendance_report_id)}/attendanceRecords"
  api_version             = "v1.0"
  update_method           = "PATCH"
  body                    = local.body
