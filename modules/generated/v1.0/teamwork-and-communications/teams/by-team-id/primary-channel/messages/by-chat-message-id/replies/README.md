...
Lifecycle: `POST /teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/{chatMessage-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/primary-channel/messages/by-chat-message-id/replies"
