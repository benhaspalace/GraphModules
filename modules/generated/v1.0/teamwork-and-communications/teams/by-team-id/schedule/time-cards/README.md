...
Lifecycle: `POST /teams/{team-id}/schedule/timeCards`, `GET/PATCH/DELETE /teams/{team-id}/schedule/timeCards/{timeCard-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/schedule/time-cards"
