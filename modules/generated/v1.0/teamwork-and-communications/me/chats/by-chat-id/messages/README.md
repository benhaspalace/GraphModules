...
Lifecycle: `POST /me/chats/{chat-id}/messages`, `GET/PATCH/DELETE /me/chats/{chat-id}/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/chats/by-chat-id/messages"
