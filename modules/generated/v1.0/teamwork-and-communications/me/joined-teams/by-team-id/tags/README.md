...
Lifecycle: `POST /me/joinedTeams/{team-id}/tags`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/tags/{teamworkTag-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/tags"
