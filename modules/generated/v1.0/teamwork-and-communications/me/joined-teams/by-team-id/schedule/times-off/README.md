...
Lifecycle: `POST /me/joinedTeams/{team-id}/schedule/timesOff`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/schedule/timesOff/{timeOff-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/schedule/times-off"
