variable "created_date_time" {
  description = "Date and time when the asynchronous operation was created."
  type        = string
  default     = null
}

variable "numbers" {
  description = "Asynchronous operation details."
  type = list(object({
...
variable "odata_type" {
  ...
  type        = string
  default     = "#microsoft.graph.teamsAdministration.telephoneNumberLongRunningOperation"
  nullable    = false
}
