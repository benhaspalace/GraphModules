...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/messages/{chatMessage-id}/replies`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/messages/{chatMessage-id}/replies/{chatMessage-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/messages/by-chat-message-id/replies"
