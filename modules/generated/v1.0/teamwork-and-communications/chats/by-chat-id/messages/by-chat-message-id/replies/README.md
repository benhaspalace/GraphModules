...
Lifecycle: `POST /chats/{chat-id}/messages/{chatMessage-id}/replies`, `GET/PATCH/DELETE /chats/{chat-id}/messages/{chatMessage-id}/replies/{chatMessage-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/messages/by-chat-message-id/replies"
