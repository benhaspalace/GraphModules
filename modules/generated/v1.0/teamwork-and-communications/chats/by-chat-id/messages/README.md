...
Lifecycle: `POST /chats/{chat-id}/messages`, `GET/PATCH/DELETE /chats/{chat-id}/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/messages"
