...
[Catalog](../../../../../README.md) · [Customer booking](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/bookingappointment?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /solutions/bookingBusinesses/{bookingBusiness-id}/appointments`, `GET/PATCH/DELETE /solutions/bookingBusinesses/{bookingBusiness-id}/appointments/{bookingAppointment-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./customer-booking/solutions/booking-businesses/by-booking-business-id/appointments"
