...
run "invalid_enum" {
  ...
  variables {
    user_preferred_method_for_secondary_authentication = "__graphmodules_invalid_enum__"
  }

  expect_failures = [var.user_preferred_method_for_secondary_authentication]
}
