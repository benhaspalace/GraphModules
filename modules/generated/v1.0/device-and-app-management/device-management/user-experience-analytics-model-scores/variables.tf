...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["appReliabilityScore", "batteryHealthScore", "endpointAnalyticsScore", "id", "manufacturer", "model", "modelDeviceCount", "startupPerformanceScore", "workFromAnywhereScore"], key)]) : false
