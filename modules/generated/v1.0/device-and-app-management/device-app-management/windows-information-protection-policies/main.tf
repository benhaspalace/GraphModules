...
locals {
  typed_body = { for key, value in {
    ...
    "daysWithoutContactBeforeUnenroll"       = var.days_without_contact_before_unenroll
    ...
    "mdmEnrollmentUrl"                       = var.mdm_enrollment_url
    "minutesOfInactivityBeforeDeviceLock"    = var.minutes_of_inactivity_before_device_lock
    ...
    "numberOfPastPinsRemembered"             = var.number_of_past_pins_remembered
    "@odata.type"                            = var.odata_type
    "passwordMaximumAttemptCount"            = var.password_maximum_attempt_count
    "pinExpirationDays"                      = var.pin_expiration_days
    "pinLowercaseLetters"                    = var.pin_lowercase_letters
    "pinMinimumLength"                       = var.pin_minimum_length
    "pinSpecialCharacters"                   = var.pin_special_characters
    "pinUppercaseLetters"                    = var.pin_uppercase_letters
    ...
    "revokeOnMdmHandoffDisabled"             = var.revoke_on_mdm_handoff_disabled
    ...
    "windowsHelloForBusinessBlocked"         = var.windows_hello_for_business_blocked
