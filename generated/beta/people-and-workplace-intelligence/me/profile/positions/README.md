...
Lifecycle: `POST /me/profile/positions`, `GET/PATCH/DELETE /me/profile/positions/{workPosition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/positions"
}
```
