...
Lifecycle: `POST /me/profile/publications`, `GET/PATCH/DELETE /me/profile/publications/{itemPublication-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/publications"
}
```
