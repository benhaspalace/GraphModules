...
Lifecycle: `POST /me/profile/interests`, `GET/PATCH/DELETE /me/profile/interests/{personInterest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/interests"
}
```
