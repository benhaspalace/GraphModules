...
Lifecycle: `POST /me/profile/anniversaries`, `GET/PATCH/DELETE /me/profile/anniversaries/{personAnnualEvent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/anniversaries"
}
```
