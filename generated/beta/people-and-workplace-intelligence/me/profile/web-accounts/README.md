...
Lifecycle: `POST /me/profile/webAccounts`, `GET/PATCH/DELETE /me/profile/webAccounts/{webAccount-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/me/profile/web-accounts"
}
```
