...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/personcertification?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/certifications`, `GET/PATCH/DELETE /users/{user-id}/profile/certifications/{personCertification-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/certifications"
...
| `certification_id` | `certificationId` | `string` | no | no |
...
| `issuing_authority` | `issuingAuthority` | `string` | no | no |
| `issuing_company` | `issuingCompany` | `string` | no | no |
