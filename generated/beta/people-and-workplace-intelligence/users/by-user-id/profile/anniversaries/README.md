...
Lifecycle: `POST /users/{user-id}/profile/anniversaries`, `GET/PATCH/DELETE /users/{user-id}/profile/anniversaries/{personAnnualEvent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/anniversaries"
