...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/projectparticipation?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/projects`, `GET/PATCH/DELETE /users/{user-id}/profile/projects/{projectParticipation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/projects"
...
| `client` | `client` | `any` | no | no |
| `collaboration_tags` | `collaborationTags` | `list(string)` | no | no |
...
| `sponsors` | `sponsors` | `list(object({       odata_type = optional(string, "#microsoft.graph.relatedPerson")       displayName = optional(string)       relationship = optional(any)       userId = optional(string)       userPrincipalName = optional(string)     }))` | no | no |
| `thumbnail_url` | `thumbnailUrl` | `string` | no | no |
...
- client: polymorphic schema; accepts an untyped value
...
- sponsors[].relationship: polymorphic schema; accepts an untyped value
