...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/languageproficiency?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/languages`, `GET/PATCH/DELETE /users/{user-id}/profile/languages/{languageProficiency-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/languages"
...
| `proficiency` | `proficiency` | `any` | no | no |
| `reading` | `reading` | `any` | no | no |
...
- proficiency: polymorphic schema; accepts an untyped value
- reading: polymorphic schema; accepts an untyped value
- source: polymorphic schema; accepts an untyped value
- spoken: polymorphic schema; accepts an untyped value
- written: polymorphic schema; accepts an untyped value
