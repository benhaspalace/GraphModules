...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/useraccountinformation?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/account`, `GET/PATCH/DELETE /users/{user-id}/profile/account/{userAccountInformation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/account"
...
| `country_code` | `countryCode` | `string` | no | no |
...
| `origin_tenant_info` | `originTenantInfo` | `any` | no | no |
| `preferred_language_tag` | `preferredLanguageTag` | `any` | no | no |
...
| `user_persona` | `userPersona` | `any` | no | no |
...
- originTenantInfo: polymorphic schema; accepts an untyped value
- preferredLanguageTag: polymorphic schema; accepts an untyped value
- source: polymorphic schema; accepts an untyped value
- userPersona: polymorphic schema; accepts an untyped value
