...
[Catalog](../../../../../README.md) · [People and workplace intelligence](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/personname?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/profile/names`, `GET/PATCH/DELETE /users/{user-id}/profile/names/{personName-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/profile/names"
...
| `last` | `last` | `string` | no | no |
| `last_modified_by` | `lastModifiedBy` | `any` | no | no |
| `last_modified_date_time` | `lastModifiedDateTime` | `string` | no | no |
| `maiden` | `maiden` | `string` | no | no |
| `middle` | `middle` | `string` | no | no |
| `nickname` | `nickname` | `string` | no | no |
| `odata_type` | `@odata.type` | `string` | no | no |
| `pronunciation` | `pronunciation` | `any` | no | no |
...
- pronunciation: polymorphic schema; accepts an untyped value
