...
run "minimal_request" {
  ...
  variables {
    ...
    education_submission_resource_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "education/classes/test-parent-id/assignments/test-parent-id/submissions/test-parent-id/submittedResources/test-parent-id/dependentResources"
