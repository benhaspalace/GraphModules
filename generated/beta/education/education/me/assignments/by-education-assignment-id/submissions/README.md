...
Lifecycle: `POST /education/me/assignments/{educationAssignment-id}/submissions`, `GET/PATCH/DELETE /education/me/assignments/{educationAssignment-id}/submissions/{educationSubmission-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./education/education/me/assignments/by-education-assignment-id/submissions"
