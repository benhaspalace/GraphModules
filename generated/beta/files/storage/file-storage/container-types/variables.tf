...
variable "permissions" {
  description = "The set of permissions for users in the container type. The permissions collection defines who has access to manage the container type. Use the owner role to grant management access."
  type = list(object({
