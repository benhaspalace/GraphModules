...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/analytics/itemActivityStats/{itemActivityStat-id}/activities`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/analytics/itemActivityStats/{itemActivityStat-id}/activities/{itemActivity-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./files/drives/by-drive-id/items/by-drive-item-id/analytics/item-activity-stats/by-item-activity-stat-id/activities"
