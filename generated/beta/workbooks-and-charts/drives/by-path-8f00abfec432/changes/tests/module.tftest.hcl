...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "drives/test-parent-id/items/test-parent-id/workbook/comments/test-parent-id/task/comment/replies/test-parent-id/task/changes"
