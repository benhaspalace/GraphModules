...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "drives/test-parent-id/items/test-parent-id/workbook/worksheets/test-parent-id/tasks/test-parent-id/comment/replies"
