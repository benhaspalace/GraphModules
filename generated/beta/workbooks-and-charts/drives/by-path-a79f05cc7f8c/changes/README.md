...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tasks/{workbookDocumentTask-id}/changes`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tasks/{workbookDocumentTask-id}/changes/{workbookDocumentTaskChange-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./workbooks-and-charts/drives/by-path-a79f05cc7f8c/changes"
