...
Lifecycle: `POST /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tasks/{workbookDocumentTask-id}/comment/task/changes`, `GET/PATCH/DELETE /drives/{drive-id}/items/{driveItem-id}/workbook/worksheets/{workbookWorksheet-id}/tasks/{workbookDocumentTask-id}/comment/task/changes/{workbookDocumentTaskChange-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./workbooks-and-charts/drives/by-path-fe36e512c0fd/changes"
