...
Lifecycle: `POST /users/{user-id}/calendars/{calendar-id}/events/{event-id}/extensions`, `GET/PATCH/DELETE /users/{user-id}/calendars/{calendar-id}/events/{event-id}/extensions/{extension-id}`.
