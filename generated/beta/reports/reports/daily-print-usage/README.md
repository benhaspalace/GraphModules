...
Lifecycle: `POST /reports/dailyPrintUsage`, `GET/PATCH/DELETE /reports/dailyPrintUsage/{printUsage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/reports/daily-print-usage"
}
```
