...
[Catalog](../../../README.md) · [Reports](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/serviceprincipalsigninactivity?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /reports/servicePrincipalSignInActivities`, `GET/PATCH/DELETE /reports/servicePrincipalSignInActivities/{servicePrincipalSignInActivity-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/reports/service-principal-sign-in-activities"
}
```
