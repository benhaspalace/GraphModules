...
[Catalog](../../../README.md) · [Reports](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/provisioningobjectsummary?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /auditLogs/directoryProvisioning`, `GET/PATCH/DELETE /auditLogs/directoryProvisioning/{provisioningObjectSummary-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/audit-logs/directory-provisioning"
}
```
...
| `status_info` | `statusInfo` | `any` | no | no |
...
- statusInfo: polymorphic schema; accepts an untyped value
