...
Lifecycle: `POST /directory/impactedResources`, `GET/PATCH/DELETE /directory/impactedResources/{impactedResource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./reports/directory/impacted-resources"
}
```
...
| `recommendation_id` | `recommendationId` | `string` | no | no |
