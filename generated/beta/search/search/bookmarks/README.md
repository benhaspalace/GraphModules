...
[Catalog](../../../README.md) · [Search](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/search-bookmark?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /search/bookmarks`, `GET/PATCH/DELETE /search/bookmarks/{bookmark-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./search/search/bookmarks"
}
```
...
| --- | --- | --- | --- | --- |
| `availability_end_date_time` | `availabilityEndDateTime` | `string` | no | no |
| `availability_start_date_time` | `availabilityStartDateTime` | `string` | no | no |
...
| `power_app_ids` | `powerAppIds` | `list(string)` | no | no |
