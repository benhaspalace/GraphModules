...
Lifecycle: `POST /tenantRelationships/managedTenants/managementTemplateStepVersions`, `GET/PATCH/DELETE /tenantRelationships/managedTenants/managementTemplateStepVersions/{managementTemplateStepVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tenants/tenant-relationships/managed-tenants/management-template-step-versions"
}
```
...
| --- | --- | --- | --- | --- |
| `accepted_for` | `acceptedFor` | `any` | no | no |
...
| `template_step` | `templateStep` | `any` | no | no |
| `version_information` | `versionInformation` | `string` | no | no |
