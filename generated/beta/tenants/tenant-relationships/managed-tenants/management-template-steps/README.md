...
Lifecycle: `POST /tenantRelationships/managedTenants/managementTemplateSteps`, `GET/PATCH/DELETE /tenantRelationships/managedTenants/managementTemplateSteps/{managementTemplateStep-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tenants/tenant-relationships/managed-tenants/management-template-steps"
}
```
