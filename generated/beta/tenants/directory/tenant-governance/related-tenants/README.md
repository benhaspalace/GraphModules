...
[Catalog](../../../../README.md) · [Tenants](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/tenantgovernanceservices-relatedtenant?view=graph-rest-beta&preserve-view=true)
...
module "graph_resource" {
  source = "./tenants/directory/tenant-governance/related-tenants"
}
```
