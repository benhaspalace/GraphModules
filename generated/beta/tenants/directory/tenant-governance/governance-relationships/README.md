# /directory/tenantGovernance/governanceRelationships

Create new navigation property to governanceRelationships for directory

[Catalog](../../../../README.md) · [Tenants](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/tenantgovernanceservices-governancerelationship?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /directory/tenantGovernance/governanceRelationships`, `GET/PATCH/DELETE /directory/tenantGovernance/governanceRelationships/{governanceRelationship-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tenants/directory/tenant-governance/governance-relationships"
}
```
...
| --- | --- | --- | --- | --- |
| `created_type` | `createdType` | `string` | no | no |
