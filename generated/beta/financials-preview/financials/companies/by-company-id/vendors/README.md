...
[Catalog](../../../../../README.md) · [Financials (preview)](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/dynamics-vendor?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /financials/companies/{company-id}/vendors`, `GET/PATCH/DELETE /financials/companies/{company-id}/vendors/{vendor-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./financials-preview/financials/companies/by-company-id/vendors"
