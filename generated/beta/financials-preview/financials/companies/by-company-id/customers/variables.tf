...
variable "shipment_method" {
  description = "Microsoft Graph shipmentMethod property."
  type        = any
  default     = null
}

variable "shipment_method_id" {
  description = "Microsoft Graph shipmentMethodId property."
  type        = string
  default     = null
}

variable "tax_area_display_name" {
  description = "Microsoft Graph taxAreaDisplayName property."
  type        = string
  default     = null
}

variable "tax_area_id" {
  description = "Microsoft Graph taxAreaId property."
  type        = string
  default     = null
}
