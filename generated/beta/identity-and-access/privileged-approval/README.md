...
Lifecycle: `POST /privilegedApproval`, `GET/PATCH/DELETE /privilegedApproval/{privilegedApproval-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-approval"
}
```
...
| `request` | `request` | `any` | no | no |
| `requestor_reason` | `requestorReason` | `string` | no | no |
