...
Lifecycle: `POST /programs/{program-id}/controls`, `GET/PATCH/DELETE /programs/{program-id}/controls/{programControl-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/programs/by-program-id/controls"
  program_id = "parent-object-id"
}
```
...
| --- | --- | --- | --- | --- |
| `program_id` | URL parameter `program-id` | `string` | yes | no |
...
| `program_id_2` | `programId` | `string` | no | no |
