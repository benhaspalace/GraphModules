...
Lifecycle: `POST /domains/{domain-id}/serviceConfigurationRecords`, `GET/PATCH/DELETE /domains/{domain-id}/serviceConfigurationRecords/{domainDnsRecord-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/domains/by-domain-id/service-configuration-records"
...
| `supported_service` | `supportedService` | `string` | no | no |
| `ttl` | `ttl` | `number` | no | no |
