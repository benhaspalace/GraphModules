...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/trustframeworkkeyset?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /trustFramework/keySets`, `GET/PATCH/DELETE /trustFramework/keySets/{trustFrameworkKeySet-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/trust-framework/key-sets"
}
```
