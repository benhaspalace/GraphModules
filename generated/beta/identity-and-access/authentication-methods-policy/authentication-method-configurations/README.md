...
Lifecycle: `POST /authenticationMethodsPolicy/authenticationMethodConfigurations`, `GET/PATCH/DELETE /authenticationMethodsPolicy/authenticationMethodConfigurations/{authenticationMethodConfiguration-id}`.
