...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "users/test-parent-id/pendingAccessReviewInstances/test-parent-id/decisions/test-parent-id/instance/stages/test-parent-id/decisions"
