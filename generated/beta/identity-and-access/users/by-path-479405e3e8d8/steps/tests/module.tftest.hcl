...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "users/test-parent-id/appConsentRequestsForApproval/test-parent-id/userConsentRequests/test-parent-id/approval/steps"
