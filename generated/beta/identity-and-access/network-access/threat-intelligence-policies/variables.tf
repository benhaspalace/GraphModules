...
variable "odata_type" {
  ...
  type        = string
  default     = "#microsoft.graph.networkaccess.threatIntelligencePolicy"
  nullable    = false
}
...
variable "settings" {
  ...
  type = object({
    odata_type    = optional(string, "#microsoft.graph.networkaccess.threatIntelligencePolicySettings")
