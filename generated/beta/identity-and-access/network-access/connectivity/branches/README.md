...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/networkaccess-branchsite?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /networkAccess/connectivity/branches`, `GET/PATCH/DELETE /networkAccess/connectivity/branches/{branchSite-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/network-access/connectivity/branches"
}
```
...
| --- | --- | --- | --- | --- |
| `bandwidth_capacity` | `bandwidthCapacity` | `number` | no | no |
| `connectivity_configuration` | `connectivityConfiguration` | `any` | no | no |
| `connectivity_state` | `connectivityState` | `any` | no | no |
...
- connectivityState: polymorphic schema; accepts an untyped value
