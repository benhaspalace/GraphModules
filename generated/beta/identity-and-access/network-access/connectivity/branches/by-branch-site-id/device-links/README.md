...
Lifecycle: `POST /networkAccess/connectivity/branches/{branchSite-id}/deviceLinks`, `GET/PATCH/DELETE /networkAccess/connectivity/branches/{branchSite-id}/deviceLinks/{deviceLink-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/network-access/connectivity/branches/by-branch-site-id/device-links"
