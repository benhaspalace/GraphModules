...
Lifecycle: `POST /networkAccess/forwardingProfiles`, `GET/PATCH/DELETE /networkAccess/forwardingProfiles/{forwardingProfile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/network-access/forwarding-profiles"
}
```
