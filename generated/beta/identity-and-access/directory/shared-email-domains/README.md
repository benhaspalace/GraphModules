...
Lifecycle: `POST /directory/sharedEmailDomains`, `GET/PATCH/DELETE /directory/sharedEmailDomains/{sharedEmailDomain-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/directory/shared-email-domains"
}
```
...
| `provisioning_status` | `provisioningStatus` | `string` | no | no |
