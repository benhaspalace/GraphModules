...
Lifecycle: `POST /me/pendingAccessReviewInstances`, `GET/PATCH/DELETE /me/pendingAccessReviewInstances/{accessReviewInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/me/pending-access-review-instances"
}
```
