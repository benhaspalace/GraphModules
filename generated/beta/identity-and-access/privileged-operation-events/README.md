...
Lifecycle: `POST /privilegedOperationEvents`, `GET/PATCH/DELETE /privilegedOperationEvents/{privilegedOperationEvent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-operation-events"
}
```
...
| `reference_key` | `referenceKey` | `string` | no | no |
| `reference_system` | `referenceSystem` | `string` | no | no |
| `request_type` | `requestType` | `string` | no | no |
| `requestor_id` | `requestorId` | `string` | no | no |
| `requestor_name` | `requestorName` | `string` | no | no |
| `role_id` | `roleId` | `string` | no | no |
| `role_name` | `roleName` | `string` | no | no |
| `tenant_id` | `tenantId` | `string` | no | no |
| `user_id` | `userId` | `string` | no | no |
| `user_mail` | `userMail` | `string` | no | no |
