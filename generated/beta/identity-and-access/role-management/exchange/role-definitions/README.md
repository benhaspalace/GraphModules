...
Lifecycle: `POST /roleManagement/exchange/roleDefinitions`, `GET/PATCH/DELETE /roleManagement/exchange/roleDefinitions/{unifiedRoleDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/exchange/role-definitions"
}
```
