...
Lifecycle: `POST /roleManagement/directory/roleEligibilityScheduleInstances`, `GET/PATCH/DELETE /roleManagement/directory/roleEligibilityScheduleInstances/{unifiedRoleEligibilityScheduleInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/directory/role-eligibility-schedule-instances"
}
```
