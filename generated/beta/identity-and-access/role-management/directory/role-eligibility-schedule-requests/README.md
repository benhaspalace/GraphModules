...
Lifecycle: `POST /roleManagement/directory/roleEligibilityScheduleRequests`, `GET/PATCH/DELETE /roleManagement/directory/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/directory/role-eligibility-schedule-requests"
}
```
