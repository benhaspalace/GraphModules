...
Lifecycle: `POST /roleManagement/entitlementManagement/roleAssignmentSchedules`, `GET/PATCH/DELETE /roleManagement/entitlementManagement/roleAssignmentSchedules/{unifiedRoleAssignmentSchedule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/entitlement-management/role-assignment-schedules"
}
```
