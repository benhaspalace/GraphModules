...
Lifecycle: `POST /roleManagement/entitlementManagement/roleEligibilityScheduleRequests`, `GET/PATCH/DELETE /roleManagement/entitlementManagement/roleEligibilityScheduleRequests/{unifiedRoleEligibilityScheduleRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/entitlement-management/role-eligibility-schedule-requests"
}
```
