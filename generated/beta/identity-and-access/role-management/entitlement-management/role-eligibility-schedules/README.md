...
Lifecycle: `POST /roleManagement/entitlementManagement/roleEligibilitySchedules`, `GET/PATCH/DELETE /roleManagement/entitlementManagement/roleEligibilitySchedules/{unifiedRoleEligibilitySchedule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/entitlement-management/role-eligibility-schedules"
}
```
