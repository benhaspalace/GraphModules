...
Lifecycle: `POST /roleManagement/defender/roleDefinitions`, `GET/PATCH/DELETE /roleManagement/defender/roleDefinitions/{unifiedRoleDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/defender/role-definitions"
}
```
