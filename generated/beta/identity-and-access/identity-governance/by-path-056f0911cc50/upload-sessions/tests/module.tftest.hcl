...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/catalogs/test-parent-id/accessPackageResourceRoles/test-parent-id/accessPackageResource/accessPackageResourceScopes/test-parent-id/accessPackageResource/uploadSessions"
