...
Lifecycle: `POST /identityGovernance/entitlementManagement/accessPackageAssignmentPolicies`, `GET/PUT/DELETE /identityGovernance/entitlementManagement/accessPackageAssignmentPolicies/{accessPackageAssignmentPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/entitlement-management/access-package-assignment-policies"
}
```
