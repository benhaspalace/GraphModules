# /identityGovernance/catalogs/{accessPackageCatalog-id}/accessPackageResourceScopes
...
Lifecycle: `POST /identityGovernance/catalogs/{accessPackageCatalog-id}/accessPackageResourceScopes`, `GET/PATCH/DELETE /identityGovernance/catalogs/{accessPackageCatalog-id}/accessPackageResourceScopes/{accessPackageResourceScope-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/catalogs/by-access-package-catalog-id/access-package-resource-scopes"
