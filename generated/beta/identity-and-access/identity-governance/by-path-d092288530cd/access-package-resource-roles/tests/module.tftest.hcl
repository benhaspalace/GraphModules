...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackageAssignments/test-parent-id/accessPackage/accessPackageResourceRoleScopes/test-parent-id/accessPackageResourceScope/accessPackageResource/accessPackageResourceRoles"
