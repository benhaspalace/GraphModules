...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/accessReviews/unified/instances/test-parent-id/decisions/test-parent-id/instance/stages/test-parent-id/decisions"
