# /identityGovernance/accessReviews/unified/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/instance/stages
...
Lifecycle: `POST /identityGovernance/accessReviews/unified/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/instance/stages`, `GET/PATCH/DELETE /identityGovernance/accessReviews/unified/instances/{accessReviewInstance-id}/decisions/{accessReviewInstanceDecisionItem-id}/instance/stages/{accessReviewStage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/by-path-5b20d9b7eb05/stages"
