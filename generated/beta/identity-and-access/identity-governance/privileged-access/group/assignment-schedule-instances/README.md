...
[Catalog](../../../../../README.md) · [Identity and access](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/privilegedaccessgroupassignmentscheduleinstance?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identityGovernance/privilegedAccess/group/assignmentScheduleInstances`, `GET/PATCH/DELETE /identityGovernance/privilegedAccess/group/assignmentScheduleInstances/{privilegedAccessGroupAssignmentScheduleInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/privileged-access/group/assignment-schedule-instances"
}
```
...
| `assignment_schedule_id` | `assignmentScheduleId` | `string` | no | no |
| `assignment_type` | `assignmentType` | `any` | no | no |
...
- assignmentType: polymorphic schema; accepts an untyped value
