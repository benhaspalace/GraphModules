...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackageCatalogs/test-parent-id/customAccessPackageWorkflowExtensions"
