...
Lifecycle: `POST /identityGovernance/permissionsAnalytics/gcp/findings`, `GET/PATCH/DELETE /identityGovernance/permissionsAnalytics/gcp/findings/{finding-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/permissions-analytics/gcp/findings"
}
```
