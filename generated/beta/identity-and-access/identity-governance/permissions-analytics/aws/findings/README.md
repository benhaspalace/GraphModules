...
Lifecycle: `POST /identityGovernance/permissionsAnalytics/aws/findings`, `GET/PATCH/DELETE /identityGovernance/permissionsAnalytics/aws/findings/{finding-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/permissions-analytics/aws/findings"
}
```
