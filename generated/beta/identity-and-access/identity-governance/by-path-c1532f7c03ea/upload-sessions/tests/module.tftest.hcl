...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackageAssignments/test-parent-id/accessPackageAssignmentResourceRoles/test-parent-id/accessPackageResourceRole/accessPackageResource/uploadSessions"
