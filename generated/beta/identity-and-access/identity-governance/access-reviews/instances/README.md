...
Lifecycle: `POST /identityGovernance/accessReviews/instances`, `GET/PATCH/DELETE /identityGovernance/accessReviews/instances/{accessReviewInstance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/access-reviews/instances"
}
```
