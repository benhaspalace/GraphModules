# /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/contactedReviewers
...
Lifecycle: `POST /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/contactedReviewers`, `GET/PATCH/DELETE /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/contactedReviewers/{accessReviewReviewer-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/access-reviews/instances/by-access-review-instance-id/contacted-reviewers"
