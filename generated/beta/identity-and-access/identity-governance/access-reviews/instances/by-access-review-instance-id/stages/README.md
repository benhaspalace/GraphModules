# /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/stages
...
Lifecycle: `POST /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/stages`, `GET/PATCH/DELETE /identityGovernance/accessReviews/instances/{accessReviewInstance-id}/stages/{accessReviewStage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/access-reviews/instances/by-access-review-instance-id/stages"
