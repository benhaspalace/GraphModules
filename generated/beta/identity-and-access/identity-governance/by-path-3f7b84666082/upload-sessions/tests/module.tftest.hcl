...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/catalogs/test-parent-id/accessPackageResources/test-parent-id/accessPackageResourceScopes/test-parent-id/accessPackageResource/uploadSessions"
