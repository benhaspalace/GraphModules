...
Lifecycle: `POST /privilegedRoleAssignments`, `GET/PATCH/DELETE /privilegedRoleAssignments/{privilegedRoleAssignment-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-role-assignments"
}
```
...
| `is_elevated` | `isElevated` | `bool` | no | no |
