...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["creationTimestamp", "id", "principalDisplayName", "principalType"], key)]) : false
