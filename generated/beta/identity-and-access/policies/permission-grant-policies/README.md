...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/permissiongrantpolicy?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /policies/permissionGrantPolicies`, `GET/PATCH/DELETE /policies/permissionGrantPolicies/{permissionGrantPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/policies/permission-grant-policies"
}
```
