...
Lifecycle: `POST /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules`, `GET/PATCH/DELETE /policies/roleManagementPolicies/{unifiedRoleManagementPolicy-id}/rules/{unifiedRoleManagementPolicyRule-id}`.
