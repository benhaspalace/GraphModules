...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/governanceresource?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /privilegedAccess/{privilegedAccess-id}/resources`, `GET/PATCH/DELETE /privilegedAccess/{privilegedAccess-id}/resources/{governanceResource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-access/by-privileged-access-id/resources"
...
| `registered_root` | `registeredRoot` | `string` | no | no |
