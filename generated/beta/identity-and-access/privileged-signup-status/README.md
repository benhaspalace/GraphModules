...
Lifecycle: `POST /privilegedSignupStatus`, `GET/PATCH/DELETE /privilegedSignupStatus/{privilegedSignupStatus-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/privileged-signup-status"
}
```
