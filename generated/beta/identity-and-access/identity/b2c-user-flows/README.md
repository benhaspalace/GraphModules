...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/b2cidentityuserflow?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identity/b2cUserFlows`, `GET/PATCH/DELETE /identity/b2cUserFlows/{b2cIdentityUserFlow-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity/b2c-user-flows"
}
```
...
| `is_language_customization_enabled` | `isLanguageCustomizationEnabled` | `bool` | no | no |
