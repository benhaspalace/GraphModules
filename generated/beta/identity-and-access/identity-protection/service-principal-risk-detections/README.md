...
[Catalog](../../../README.md) · [Identity and access](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/serviceprincipalriskdetection?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identityProtection/servicePrincipalRiskDetections`, `GET/PATCH/DELETE /identityProtection/servicePrincipalRiskDetections/{servicePrincipalRiskDetection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-protection/service-principal-risk-detections"
}
```
...
| `key_ids` | `keyIds` | `list(string)` | no | no |
...
| `service_principal_display_name` | `servicePrincipalDisplayName` | `string` | no | no |
