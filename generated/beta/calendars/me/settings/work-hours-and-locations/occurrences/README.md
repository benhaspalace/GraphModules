# /me/settings/workHoursAndLocations/occurrences
...
Lifecycle: `POST /me/settings/workHoursAndLocations/occurrences`, `GET/PUT/DELETE /me/settings/workHoursAndLocations/occurrences/{workPlanOccurrence-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/me/settings/work-hours-and-locations/occurrences"
}
```
