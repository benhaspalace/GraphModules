...
Lifecycle: `POST /me/settings/workHoursAndLocations/recurrences`, `GET/PUT/DELETE /me/settings/workHoursAndLocations/recurrences/{workPlanRecurrence-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/me/settings/work-hours-and-locations/recurrences"
}
```
