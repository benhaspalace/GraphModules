...
Lifecycle: `POST /groups/{group-id}/calendar/events`, `GET/PATCH/DELETE /groups/{group-id}/calendar/events/{event-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/groups/by-group-id/calendar/events"
