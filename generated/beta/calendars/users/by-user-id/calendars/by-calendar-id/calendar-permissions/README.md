...
Lifecycle: `POST /users/{user-id}/calendars/{calendar-id}/calendarPermissions`, `GET/PATCH/DELETE /users/{user-id}/calendars/{calendar-id}/calendarPermissions/{calendarPermission-id}`.
