# /users/{user-id}/settings/workHoursAndLocations/occurrences

Create new navigation property to occurrences for users

[Catalog](../../../../../../README.md) · [Calendars](../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/workplanoccurrence?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/settings/workHoursAndLocations/occurrences`, `GET/PUT/DELETE /users/{user-id}/settings/workHoursAndLocations/occurrences/{workPlanOccurrence-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./calendars/users/by-user-id/settings/work-hours-and-locations/occurrences"
