...
Lifecycle: `POST /users/{user-id}/outlook/tasks`, `GET/PATCH/DELETE /users/{user-id}/outlook/tasks/{outlookTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./to-do-tasks/users/by-user-id/outlook/tasks"
