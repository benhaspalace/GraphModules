...
[Catalog](../../../../../../../README.md) · [To-do tasks](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/todotask?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/todo/lists/{todoTaskList-id}/tasks`, `GET/PATCH/DELETE /users/{user-id}/todo/lists/{todoTaskList-id}/tasks/{todoTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./to-do-tasks/users/by-user-id/todo/lists/by-todo-task-list-id/tasks"
...
| `single_value_extended_properties` | `singleValueExtendedProperties` | `list(object({       odata_type = optional(string, "#microsoft.graph.singleValueExtendedProperty")       value = optional(string)     }))` | no | no |
