...
Lifecycle: `POST /informationProtection/dataLossPreventionPolicies`, `GET/PATCH/DELETE /informationProtection/dataLossPreventionPolicies/{dataLossPreventionPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./other/information-protection/data-loss-prevention-policies"
}
```
