...
Lifecycle: `POST /app/calls/{call-id}/operations`, `GET/PATCH/DELETE /app/calls/{call-id}/operations/{commsOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./other/app/calls/by-call-id/operations"
