...
Lifecycle: `POST /approvalWorkflowProviders/{approvalWorkflowProvider-id}/businessFlowsWithRequestsAwaitingMyDecision`, `GET/PATCH/DELETE /approvalWorkflowProviders/{approvalWorkflowProvider-id}/businessFlowsWithRequestsAwaitingMyDecision/{businessFlow-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./other/approval-workflow-providers/by-approval-workflow-provider-id/business-flows-with-requests-awaiting-my-decision"
