...
Lifecycle: `POST /users/{user-id}/mobileAppTroubleshootingEvents`, `GET/PATCH/DELETE /users/{user-id}/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/users/by-user-id/mobile-app-troubleshooting-events"
