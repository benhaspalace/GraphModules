...
Lifecycle: `POST /users/{user-id}/teamwork/associatedTeams`, `GET/PATCH/DELETE /users/{user-id}/teamwork/associatedTeams/{associatedTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/teamwork/associated-teams"
