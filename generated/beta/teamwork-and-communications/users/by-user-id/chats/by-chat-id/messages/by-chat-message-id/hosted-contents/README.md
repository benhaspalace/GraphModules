...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/hostedContents`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/messages/{chatMessage-id}/hostedContents/{chatMessageHostedContent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/messages/by-chat-message-id/hosted-contents"
