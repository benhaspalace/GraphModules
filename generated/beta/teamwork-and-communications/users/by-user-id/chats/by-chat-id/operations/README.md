...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/operations`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/operations/{teamsAsyncOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/operations"
