...
Lifecycle: `POST /users/{user-id}/onlineMeetings/{onlineMeeting-id}/registration/registrants`, `GET/PATCH/DELETE /users/{user-id}/onlineMeetings/{onlineMeeting-id}/registration/registrants/{meetingRegistrantBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/online-meetings/by-online-meeting-id/registration/registrants"
