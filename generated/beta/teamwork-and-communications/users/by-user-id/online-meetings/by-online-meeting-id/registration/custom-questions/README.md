...
Lifecycle: `POST /users/{user-id}/onlineMeetings/{onlineMeeting-id}/registration/customQuestions`, `GET/PATCH/DELETE /users/{user-id}/onlineMeetings/{onlineMeeting-id}/registration/customQuestions/{meetingRegistrationQuestion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/online-meetings/by-online-meeting-id/registration/custom-questions"
