...
Lifecycle: `POST /app/onlineMeetings/{onlineMeeting-id}/registration/customQuestions`, `GET/PATCH/DELETE /app/onlineMeetings/{onlineMeeting-id}/registration/customQuestions/{meetingRegistrationQuestion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/app/online-meetings/by-online-meeting-id/registration/custom-questions"
