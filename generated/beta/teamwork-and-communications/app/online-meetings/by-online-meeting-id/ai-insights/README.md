...
Lifecycle: `POST /app/onlineMeetings/{onlineMeeting-id}/aiInsights`, `GET/PATCH/DELETE /app/onlineMeetings/{onlineMeeting-id}/aiInsights/{callAiInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/app/online-meetings/by-online-meeting-id/ai-insights"
