# /app/calls/{call-id}/participants

Create new navigation property to participants for app

[Catalog](../../../../../README.md) · [Teamwork and communications](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/participant?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /app/calls/{call-id}/participants`, `GET/PATCH/DELETE /app/calls/{call-id}/participants/{participant-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/app/calls/by-call-id/participants"
