...
Lifecycle: `POST /appCatalogs/teamsApps/{teamsApp-id}/appDefinitions/{teamsAppDefinition-id}/dashboardCards`, `GET/PATCH/DELETE /appCatalogs/teamsApps/{teamsApp-id}/appDefinitions/{teamsAppDefinition-id}/dashboardCards/{teamsAppDashboardCardDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/app-catalogs/teams-apps/by-teams-app-id/app-definitions/by-teams-app-definition-id/dashboard-cards"
  teams_app_id = "parent-object-id"
  teams_app_definition_id = "parent-object-id"
}
```
