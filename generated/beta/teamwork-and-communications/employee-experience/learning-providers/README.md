...
[Catalog](../../../README.md) · [Teamwork and communications](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/learningprovider?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /employeeExperience/learningProviders`, `GET/PATCH/DELETE /employeeExperience/learningProviders/{learningProvider-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/employee-experience/learning-providers"
}
```
...
| `square_logo_web_url_for_dark_theme` | `squareLogoWebUrlForDarkTheme` | `string` | no | no |
| `square_logo_web_url_for_light_theme` | `squareLogoWebUrlForLightTheme` | `string` | no | no |
