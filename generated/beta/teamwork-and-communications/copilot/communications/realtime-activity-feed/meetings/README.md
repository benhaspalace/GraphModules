...
Create new navigation property to meetings for copilot
...
Lifecycle: `POST /copilot/communications/realtimeActivityFeed/meetings`, `GET/PATCH/DELETE /copilot/communications/realtimeActivityFeed/meetings/{realtimeActivityMeeting-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/copilot/communications/realtime-activity-feed/meetings"
}
```
