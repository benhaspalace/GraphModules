...
Create new navigation property to multiActivitySubscriptions for copilot
...
Lifecycle: `POST /copilot/communications/realtimeActivityFeed/multiActivitySubscriptions`, `GET/PATCH/DELETE /copilot/communications/realtimeActivityFeed/multiActivitySubscriptions/{multiActivitySubscription-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/copilot/communications/realtime-activity-feed/multi-activity-subscriptions"
}
```
