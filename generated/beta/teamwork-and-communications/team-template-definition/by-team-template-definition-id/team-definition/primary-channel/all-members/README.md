...
Lifecycle: `POST /teamTemplateDefinition/{teamTemplateDefinition-id}/teamDefinition/primaryChannel/allMembers`, `GET/PATCH/DELETE /teamTemplateDefinition/{teamTemplateDefinition-id}/teamDefinition/primaryChannel/allMembers/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/team-template-definition/by-team-template-definition-id/team-definition/primary-channel/all-members"
