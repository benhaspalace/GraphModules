...
Lifecycle: `POST /communications/onlineMeetings/{onlineMeeting-id}/aiInsights`, `GET/PATCH/DELETE /communications/onlineMeetings/{onlineMeeting-id}/aiInsights/{callAiInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/communications/online-meetings/by-online-meeting-id/ai-insights"
