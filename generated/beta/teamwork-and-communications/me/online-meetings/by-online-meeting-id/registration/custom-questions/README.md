...
Lifecycle: `POST /me/onlineMeetings/{onlineMeeting-id}/registration/customQuestions`, `GET/PATCH/DELETE /me/onlineMeetings/{onlineMeeting-id}/registration/customQuestions/{meetingRegistrationQuestion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/online-meetings/by-online-meeting-id/registration/custom-questions"
