...
Lifecycle: `POST /me/onlineMeetings/{onlineMeeting-id}/registration/registrants`, `GET/PATCH/DELETE /me/onlineMeetings/{onlineMeeting-id}/registration/registrants/{meetingRegistrantBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/online-meetings/by-online-meeting-id/registration/registrants"
