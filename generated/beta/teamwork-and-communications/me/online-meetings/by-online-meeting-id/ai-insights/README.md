...
Lifecycle: `POST /me/onlineMeetings/{onlineMeeting-id}/aiInsights`, `GET/PATCH/DELETE /me/onlineMeetings/{onlineMeeting-id}/aiInsights/{callAiInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/online-meetings/by-online-meeting-id/ai-insights"
