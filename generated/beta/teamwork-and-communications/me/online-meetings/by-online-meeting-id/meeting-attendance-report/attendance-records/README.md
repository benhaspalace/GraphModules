...
Lifecycle: `POST /me/onlineMeetings/{onlineMeeting-id}/meetingAttendanceReport/attendanceRecords`, `GET/PATCH/DELETE /me/onlineMeetings/{onlineMeeting-id}/meetingAttendanceReport/attendanceRecords/{attendanceRecord-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/online-meetings/by-online-meeting-id/meeting-attendance-report/attendance-records"
