...
Lifecycle: `POST /me/teamwork/associatedTeams`, `GET/PATCH/DELETE /me/teamwork/associatedTeams/{associatedTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/teamwork/associated-teams"
}
```
