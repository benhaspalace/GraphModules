...
Lifecycle: `POST /groups/{group-id}/team/operations`, `GET/PATCH/DELETE /groups/{group-id}/team/operations/{teamsAsyncOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/operations"
