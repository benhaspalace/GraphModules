...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/sharedWithTeams`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/shared-with-teams"
