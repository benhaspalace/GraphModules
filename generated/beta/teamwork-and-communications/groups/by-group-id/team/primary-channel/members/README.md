...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/members`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/members/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/members"
