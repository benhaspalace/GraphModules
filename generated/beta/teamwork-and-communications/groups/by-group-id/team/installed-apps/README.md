...
Lifecycle: `POST /groups/{group-id}/team/installedApps`, `GET/PATCH/DELETE /groups/{group-id}/team/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/installed-apps"
