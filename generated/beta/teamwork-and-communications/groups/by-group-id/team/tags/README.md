...
Lifecycle: `POST /groups/{group-id}/team/tags`, `GET/PATCH/DELETE /groups/{group-id}/team/tags/{teamworkTag-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/tags"
