...
Lifecycle: `POST /groups/{group-id}/team/schedule/openShifts`, `GET/PATCH/DELETE /groups/{group-id}/team/schedule/openShifts/{openShift-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/schedule/open-shifts"
