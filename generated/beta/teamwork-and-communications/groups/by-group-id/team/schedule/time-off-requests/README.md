...
Lifecycle: `POST /groups/{group-id}/team/schedule/timeOffRequests`, `GET/PATCH/DELETE /groups/{group-id}/team/schedule/timeOffRequests/{timeOffRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/schedule/time-off-requests"
