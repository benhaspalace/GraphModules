variable "audience" {
  description = "The audience to whom the town hall is visible. The possible values are: everyone, organization, unknownFutureValue."
  type        = any
  default     = null
...
variable "capacity" {
  description = "Microsoft Graph capacity property."
  type        = number
  default     = null
}
