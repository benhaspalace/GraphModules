...
Lifecycle: `POST /solutions/virtualEvents/events/{virtualEvent-id}/presenters`, `GET/PATCH/DELETE /solutions/virtualEvents/events/{virtualEvent-id}/presenters/{virtualEventPresenter-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/solutions/virtual-events/events/by-virtual-event-id/presenters"
