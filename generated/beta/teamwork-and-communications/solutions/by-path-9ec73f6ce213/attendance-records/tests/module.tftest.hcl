...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "solutions/virtualEvents/events/test-parent-id/sessions/test-parent-id/attendanceReports/test-parent-id/attendanceRecords"
