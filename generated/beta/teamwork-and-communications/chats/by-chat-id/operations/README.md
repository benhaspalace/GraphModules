...
Lifecycle: `POST /chats/{chat-id}/operations`, `GET/PATCH/DELETE /chats/{chat-id}/operations/{teamsAsyncOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/operations"
