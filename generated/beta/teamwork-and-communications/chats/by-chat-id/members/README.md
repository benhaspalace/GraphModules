...
Lifecycle: `POST /chats/{chat-id}/members`, `GET/PATCH/DELETE /chats/{chat-id}/members/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/members"
