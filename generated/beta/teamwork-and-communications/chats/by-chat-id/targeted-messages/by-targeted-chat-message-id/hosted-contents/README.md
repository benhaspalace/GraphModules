...
Lifecycle: `POST /chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/hostedContents`, `GET/PATCH/DELETE /chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/hostedContents/{chatMessageHostedContent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/targeted-messages/by-targeted-chat-message-id/hosted-contents"
