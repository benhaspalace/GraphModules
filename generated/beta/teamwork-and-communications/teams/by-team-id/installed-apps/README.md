...
Lifecycle: `POST /teams/{team-id}/installedApps`, `GET/PATCH/DELETE /teams/{team-id}/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/installed-apps"
