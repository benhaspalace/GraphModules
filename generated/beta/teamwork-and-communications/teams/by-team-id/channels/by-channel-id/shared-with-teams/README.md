...
Lifecycle: `POST /teams/{team-id}/channels/{channel-id}/sharedWithTeams`, `GET/PATCH/DELETE /teams/{team-id}/channels/{channel-id}/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/channels/by-channel-id/shared-with-teams"
