...
Lifecycle: `POST /teams/{team-id}/operations`, `GET/PATCH/DELETE /teams/{team-id}/operations/{teamsAsyncOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/operations"
