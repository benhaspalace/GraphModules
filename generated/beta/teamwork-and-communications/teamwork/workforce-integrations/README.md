...
[Catalog](../../../README.md) · [Teamwork and communications](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/workforceintegration?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /teamwork/workforceIntegrations`, `GET/PATCH/DELETE /teamwork/workforceIntegrations/{workforceIntegration-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teamwork/workforce-integrations"
}
```
...
- supports: polymorphic schema; accepts an untyped value
