...
Lifecycle: `POST /teamwork/teamTemplates`, `GET/PATCH/DELETE /teamwork/teamTemplates/{teamTemplate-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teamwork/team-templates"
}
```
