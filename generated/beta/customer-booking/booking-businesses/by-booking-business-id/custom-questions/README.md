...
Lifecycle: `POST /bookingBusinesses/{bookingBusiness-id}/customQuestions`, `GET/PATCH/DELETE /bookingBusinesses/{bookingBusiness-id}/customQuestions/{bookingCustomQuestion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./customer-booking/booking-businesses/by-booking-business-id/custom-questions"
