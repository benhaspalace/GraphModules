...
Lifecycle: `POST /users/{user-id}/mailFolders/{mailFolder-id}/messages`, `GET/PATCH/DELETE /users/{user-id}/mailFolders/{mailFolder-id}/messages/{message-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./mail/users/by-user-id/mail-folders/by-mail-folder-id/messages"
