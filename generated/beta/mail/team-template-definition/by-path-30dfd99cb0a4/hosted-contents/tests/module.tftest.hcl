...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamTemplateDefinition/test-parent-id/teamDefinition/channels/test-parent-id/messages/test-parent-id/hostedContents"
