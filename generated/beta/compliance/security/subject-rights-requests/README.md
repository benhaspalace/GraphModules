...
Lifecycle: `POST /security/subjectRightsRequests`, `GET/PATCH/DELETE /security/subjectRightsRequests/{subjectRightsRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/security/subject-rights-requests"
}
```
