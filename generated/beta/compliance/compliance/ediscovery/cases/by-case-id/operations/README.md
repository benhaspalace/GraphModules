...
Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/operations`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/operations/{caseOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/operations"
