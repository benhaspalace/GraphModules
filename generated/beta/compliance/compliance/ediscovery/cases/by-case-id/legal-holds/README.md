...
[Catalog](../../../../../../README.md) · [Compliance](../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/ediscovery-legalhold?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/legalHolds`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/legalHolds/{legalHold-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/legal-holds"
