...
Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/legalHolds/{legalHold-id}/userSources`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/legalHolds/{legalHold-id}/userSources/{userSource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/legal-holds/by-legal-hold-id/user-sources"
