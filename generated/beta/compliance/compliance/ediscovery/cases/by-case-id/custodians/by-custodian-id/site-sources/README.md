...
Lifecycle: `POST /compliance/ediscovery/cases/{case-id}/custodians/{custodian-id}/siteSources`, `GET/PATCH/DELETE /compliance/ediscovery/cases/{case-id}/custodians/{custodian-id}/siteSources/{siteSource-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/compliance/ediscovery/cases/by-case-id/custodians/by-custodian-id/site-sources"
