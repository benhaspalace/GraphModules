...
Lifecycle: `POST /dataClassification/exactMatchUploadAgents`, `GET/PATCH/DELETE /dataClassification/exactMatchUploadAgents/{exactMatchUploadAgent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/exact-match-upload-agents"
}
```
