...
Lifecycle: `POST /dataClassification/classifyTextJobs`, `GET/PATCH/DELETE /dataClassification/classifyTextJobs/{jobResponseBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/classify-text-jobs"
}
```
