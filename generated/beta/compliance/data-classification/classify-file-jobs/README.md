...
Lifecycle: `POST /dataClassification/classifyFileJobs`, `GET/PATCH/DELETE /dataClassification/classifyFileJobs/{jobResponseBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/classify-file-jobs"
}
```
