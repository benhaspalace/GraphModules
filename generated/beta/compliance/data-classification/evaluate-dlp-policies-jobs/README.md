...
Lifecycle: `POST /dataClassification/evaluateDlpPoliciesJobs`, `GET/PATCH/DELETE /dataClassification/evaluateDlpPoliciesJobs/{jobResponseBase-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./compliance/data-classification/evaluate-dlp-policies-jobs"
}
```
