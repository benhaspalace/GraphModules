variable "content" {
  description = "The content of the goalsExportJob."
  type        = string
  default     = null
}
...
variable "expiration_date_time" {
  description = "The date and time of expiry of the result of the operation."
  type        = string
  default     = null
}

variable "explorer_view_id" {
  description = "The unique identifier of the explorer view to be exported."
  type        = string
  default     = null
}

variable "goals_organization_id" {
  description = "The unique identifier of the viva goals organization."
  type        = string
  default     = null
}
...
variable "odata_type" {
  ...
  type        = string
  default     = "#microsoft.graph.goalsExportJob"
  nullable    = false
}
