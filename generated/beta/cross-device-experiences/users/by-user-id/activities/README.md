...
Lifecycle: `POST /users/{user-id}/activities`, `GET/PATCH/DELETE /users/{user-id}/activities/{userActivity-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./cross-device-experiences/users/by-user-id/activities"
