...
Lifecycle: `POST /me/activities/{userActivity-id}/historyItems`, `GET/PATCH/DELETE /me/activities/{userActivity-id}/historyItems/{activityHistoryItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./cross-device-experiences/me/activities/by-user-activity-id/history-items"
