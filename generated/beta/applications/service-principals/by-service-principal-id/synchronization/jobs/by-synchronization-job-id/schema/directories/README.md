...
Lifecycle: `POST /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/directories`, `GET/PATCH/DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/jobs/{synchronizationJob-id}/schema/directories/{directoryDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./applications/service-principals/by-service-principal-id/synchronization/jobs/by-synchronization-job-id/schema/directories"
