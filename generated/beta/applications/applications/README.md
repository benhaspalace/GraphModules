...
| `on_premises_publishing` | `onPremisesPublishing` | `any` | no | no |
...
| `sign_in_audience_restrictions` | `signInAudienceRestrictions` | `object({       odata_type = optional(string, "#microsoft.graph.signInAudienceRestrictionsBase")       kind = optional(string)     })` | no | no |
| `spa` | `spa` | `any` | no | no |
...
- connectorGroup: polymorphic schema; accepts an untyped value
...
- onPremisesPublishing: polymorphic schema; accepts an untyped value
...
- windows: polymorphic schema; accepts an untyped value
