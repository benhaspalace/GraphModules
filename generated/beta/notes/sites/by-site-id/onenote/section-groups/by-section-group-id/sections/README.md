...
Lifecycle: `POST /sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}/sections`, `GET/PATCH/DELETE /sites/{site-id}/onenote/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/sites/by-site-id/onenote/section-groups/by-section-group-id/sections"
