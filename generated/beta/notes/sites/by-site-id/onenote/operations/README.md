...
Lifecycle: `POST /sites/{site-id}/onenote/operations`, `GET/PATCH/DELETE /sites/{site-id}/onenote/operations/{onenoteOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/sites/by-site-id/onenote/operations"
