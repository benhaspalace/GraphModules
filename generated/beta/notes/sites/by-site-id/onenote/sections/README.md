...
Lifecycle: `POST /sites/{site-id}/onenote/sections`, `GET/PATCH/DELETE /sites/{site-id}/onenote/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/sites/by-site-id/onenote/sections"
