...
Lifecycle: `POST /users/{user-id}/onenote/operations`, `GET/PATCH/DELETE /users/{user-id}/onenote/operations/{onenoteOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/users/by-user-id/onenote/operations"
