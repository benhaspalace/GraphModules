...
Lifecycle: `POST /users/{user-id}/onenote/sections`, `GET/PATCH/DELETE /users/{user-id}/onenote/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/users/by-user-id/onenote/sections"
