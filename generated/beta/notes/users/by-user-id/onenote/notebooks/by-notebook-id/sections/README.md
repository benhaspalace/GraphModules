...
Lifecycle: `POST /users/{user-id}/onenote/notebooks/{notebook-id}/sections`, `GET/PATCH/DELETE /users/{user-id}/onenote/notebooks/{notebook-id}/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/users/by-user-id/onenote/notebooks/by-notebook-id/sections"
