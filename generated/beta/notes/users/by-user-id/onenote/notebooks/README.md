...
Lifecycle: `POST /users/{user-id}/onenote/notebooks`, `GET/PATCH/DELETE /users/{user-id}/onenote/notebooks/{notebook-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/users/by-user-id/onenote/notebooks"
