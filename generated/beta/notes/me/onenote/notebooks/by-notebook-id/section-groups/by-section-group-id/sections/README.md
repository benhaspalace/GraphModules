...
Lifecycle: `POST /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections`, `GET/PATCH/DELETE /me/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/me/onenote/notebooks/by-notebook-id/section-groups/by-section-group-id/sections"
