...
Lifecycle: `POST /groups/{group-id}/onenote/operations`, `GET/PATCH/DELETE /groups/{group-id}/onenote/operations/{onenoteOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/groups/by-group-id/onenote/operations"
