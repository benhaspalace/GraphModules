...
Lifecycle: `POST /groups/{group-id}/onenote/notebooks`, `GET/PATCH/DELETE /groups/{group-id}/onenote/notebooks/{notebook-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/groups/by-group-id/onenote/notebooks"
