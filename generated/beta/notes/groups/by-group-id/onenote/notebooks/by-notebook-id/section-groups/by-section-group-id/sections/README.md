...
Lifecycle: `POST /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections`, `GET/PATCH/DELETE /groups/{group-id}/onenote/notebooks/{notebook-id}/sectionGroups/{sectionGroup-id}/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/groups/by-group-id/onenote/notebooks/by-notebook-id/section-groups/by-section-group-id/sections"
