...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/onenote/sections`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/onenote/sections/{onenoteSection-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/groups/by-group-id/sites/by-site-id/onenote/sections"
