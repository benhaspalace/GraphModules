...
[Catalog](../../../../../../../README.md) · [Notes](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/notebook?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /groups/{group-id}/sites/{site-id}/onenote/notebooks`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/onenote/notebooks/{notebook-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notes/groups/by-group-id/sites/by-site-id/onenote/notebooks"
