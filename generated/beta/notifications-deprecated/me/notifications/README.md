...
[Catalog](../../../README.md) · [Notifications (deprecated)](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/projectrome-notification?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /me/notifications`, `GET/PATCH/DELETE /me/notifications/{notification-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./notifications-deprecated/me/notifications"
}
```
...
| --- | --- | --- | --- | --- |
| `display_time_to_live` | `displayTimeToLive` | `number` | no | no |
