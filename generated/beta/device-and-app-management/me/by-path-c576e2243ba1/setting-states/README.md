...
Lifecycle: `POST /me/managedDevices/{managedDevice-id}/securityBaselineStates/{securityBaselineState-id}/settingStates`, `GET/PATCH/DELETE /me/managedDevices/{managedDevice-id}/securityBaselineStates/{securityBaselineState-id}/settingStates/{securityBaselineSettingState-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/me/by-path-c576e2243ba1/setting-states"
