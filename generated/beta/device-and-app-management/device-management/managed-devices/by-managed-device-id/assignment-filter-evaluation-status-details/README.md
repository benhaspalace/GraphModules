...
Lifecycle: `POST /deviceManagement/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails`, `GET/PATCH/DELETE /deviceManagement/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/managed-devices/by-managed-device-id/assignment-filter-evaluation-status-details"
