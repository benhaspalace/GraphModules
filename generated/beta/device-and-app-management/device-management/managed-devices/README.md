...
Lifecycle: `POST /deviceManagement/managedDevices`, `GET/PATCH/DELETE /deviceManagement/managedDevices/{managedDevice-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/managed-devices"
}
```
