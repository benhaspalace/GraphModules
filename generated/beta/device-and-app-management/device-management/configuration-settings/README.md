...
Lifecycle: `POST /deviceManagement/configurationSettings`, `GET/PATCH/DELETE /deviceManagement/configurationSettings/{deviceManagementConfigurationSettingDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/configuration-settings"
}
```
