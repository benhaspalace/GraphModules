...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/groupPolicyDefinitions/test-parent-id/previousVersionDefinition/nextVersionDefinition/presentations"
