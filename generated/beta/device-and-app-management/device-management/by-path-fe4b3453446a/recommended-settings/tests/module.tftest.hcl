...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/templates/test-parent-id/migratableTo/test-parent-id/categories/test-parent-id/recommendedSettings"
