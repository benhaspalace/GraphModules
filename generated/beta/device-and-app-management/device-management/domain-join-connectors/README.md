...
Lifecycle: `POST /deviceManagement/domainJoinConnectors`, `GET/PATCH/DELETE /deviceManagement/domainJoinConnectors/{deviceManagementDomainJoinConnector-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/domain-join-connectors"
}
```
