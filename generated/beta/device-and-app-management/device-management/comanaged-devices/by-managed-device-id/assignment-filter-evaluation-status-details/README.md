...
Lifecycle: `POST /deviceManagement/comanagedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails`, `GET/PATCH/DELETE /deviceManagement/comanagedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/comanaged-devices/by-managed-device-id/assignment-filter-evaluation-status-details"
