...
Lifecycle: `POST /deviceManagement/derivedCredentials`, `GET/PATCH/DELETE /deviceManagement/derivedCredentials/{deviceManagementDerivedCredentialSettings-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/derived-credentials"
}
```
...
| `renewal_threshold_percentage` | `renewalThresholdPercentage` | `number` | no | no |
