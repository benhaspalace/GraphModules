...
Lifecycle: `POST /deviceManagement/templates/{deviceManagementTemplate-id}/migratableTo`, `GET/PATCH/DELETE /deviceManagement/templates/{deviceManagementTemplate-id}/migratableTo/{deviceManagementTemplate-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/templates/by-device-management-template-id/migratable-to"
