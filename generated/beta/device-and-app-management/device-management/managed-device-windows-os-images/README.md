...
Lifecycle: `POST /deviceManagement/managedDeviceWindowsOSImages`, `GET/PATCH/DELETE /deviceManagement/managedDeviceWindowsOSImages/{managedDeviceWindowsOperatingSystemImage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/managed-device-windows-os-images"
}
```
