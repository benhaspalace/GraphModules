...
| `device_management_compliance_scheduled_action_for_rule_id` | URL parameter `deviceManagementComplianceScheduledActionForRule-id` | `string` | yes | no |
