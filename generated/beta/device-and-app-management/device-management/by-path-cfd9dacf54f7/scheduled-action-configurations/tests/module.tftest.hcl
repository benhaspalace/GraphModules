...
run "minimal_request" {
  ...
  variables {
    ...
    device_management_compliance_scheduled_action_for_rule_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "deviceManagement/compliancePolicies/test-parent-id/scheduledActionsForRule/test-parent-id/scheduledActionConfigurations"
...
run "invalid_enum" {
  ...
  variables {
    device_management_compliance_policy_id                    = "test-parent-id"
    device_management_compliance_scheduled_action_for_rule_id = "test-parent-id"
    action_type                                               = "__graphform_invalid_enum__"
  }
