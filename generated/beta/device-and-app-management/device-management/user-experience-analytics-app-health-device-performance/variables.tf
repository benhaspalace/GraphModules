...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["appCrashCount", "appHangCount", "crashedAppCount", "deviceAppHealthScore", "deviceDisplayName", "deviceId", "deviceManufacturer", "deviceModel", "id", "meanTimeToFailureInMinutes", "processedDateTime"], key)]) : false
