...
Lifecycle: `POST /deviceManagement/compliancePolicies`, `GET/PATCH/DELETE /deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/compliance-policies"
}
```
