...
Lifecycle: `POST /deviceManagement/configurationPolicies`, `GET/PATCH/DELETE /deviceManagement/configurationPolicies/{deviceManagementConfigurationPolicy-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/configuration-policies"
}
```
