...
Lifecycle: `POST /deviceManagement/microsoftTunnelServerLogCollectionResponses`, `GET/PATCH/DELETE /deviceManagement/microsoftTunnelServerLogCollectionResponses/{microsoftTunnelServerLogCollectionResponse-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/microsoft-tunnel-server-log-collection-responses"
}
```
...
| `server_id` | `serverId` | `string` | no | no |
