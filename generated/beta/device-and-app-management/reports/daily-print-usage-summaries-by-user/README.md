...
Lifecycle: `POST /reports/dailyPrintUsageSummariesByUser`, `GET/PATCH/DELETE /reports/dailyPrintUsageSummariesByUser/{printUsageByUser-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/reports/daily-print-usage-summaries-by-user"
}
```
