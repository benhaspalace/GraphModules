...
Lifecycle: `POST /reports/monthlyPrintUsageByPrinter`, `GET/PATCH/DELETE /reports/monthlyPrintUsageByPrinter/{printUsageByPrinter-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/reports/monthly-print-usage-by-printer"
}
```
