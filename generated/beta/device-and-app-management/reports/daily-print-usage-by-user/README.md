...
Lifecycle: `POST /reports/dailyPrintUsageByUser`, `GET/PATCH/DELETE /reports/dailyPrintUsageByUser/{printUsageByUser-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/reports/daily-print-usage-by-user"
}
```
