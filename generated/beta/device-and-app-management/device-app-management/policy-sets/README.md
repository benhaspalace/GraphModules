...
Lifecycle: `POST /deviceAppManagement/policySets`, `GET/PATCH/DELETE /deviceAppManagement/policySets/{policySet-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-app-management/policy-sets"
}
```
...
| --- | --- | --- | --- | --- |
| `assignments` | `assignments` | `list(object({       odata_type = optional(string, "#microsoft.graph.policySetAssignment")       lastModifiedDateTime = optional(string)       target = optional(any)     }))` | no | no |
