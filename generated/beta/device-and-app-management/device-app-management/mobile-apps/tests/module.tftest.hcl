...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["assignments", "categories", "description", "developer", "displayName", "informationUrl", "isFeatured", "largeIcon", "notes", "owner", "privacyInformationUrl", "publisher", "publishingState", "relationships", "roleScopeTagIds"] : !contains(keys(msgraph_resource.this.body), key)])
