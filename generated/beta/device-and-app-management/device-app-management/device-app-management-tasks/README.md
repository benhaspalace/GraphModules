...
Lifecycle: `POST /deviceAppManagement/deviceAppManagementTasks`, `GET/PATCH/DELETE /deviceAppManagement/deviceAppManagementTasks/{deviceAppManagementTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-app-management/device-app-management-tasks"
}
```
...
| `creator_notes` | `creatorNotes` | `string` | no | no |
