...
Lifecycle: `POST /admin/serviceAnnouncement/issues`, `GET/PATCH/DELETE /admin/serviceAnnouncement/issues/{serviceHealthIssue-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/admin/service-announcement/issues"
}
```
