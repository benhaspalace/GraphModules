...
[Catalog](../../../../../../README.md) · [Device and app management](../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/servicehealthissue?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /admin/serviceAnnouncement/healthOverviews/{serviceHealth-id}/issues`, `GET/PATCH/DELETE /admin/serviceAnnouncement/healthOverviews/{serviceHealth-id}/issues/{serviceHealthIssue-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/admin/service-announcement/health-overviews/by-service-health-id/issues"
  service_health_id = "parent-object-id"
}
```
...
| --- | --- | --- | --- | --- |
| `service_health_id` | URL parameter `serviceHealth-id` | `string` | yes | no |
...
| `feature_group` | `featureGroup` | `string` | no | no |
| `impact_description` | `impactDescription` | `string` | no | no |
| `is_resolved` | `isResolved` | `bool` | no | no |
