...
Lifecycle: `POST /users/{user-id}/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails`, `GET/PATCH/DELETE /users/{user-id}/managedDevices/{managedDevice-id}/assignmentFilterEvaluationStatusDetails/{assignmentFilterEvaluationStatusDetails-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/users/by-user-id/managed-devices/by-managed-device-id/assignment-filter-evaluation-status-details"
