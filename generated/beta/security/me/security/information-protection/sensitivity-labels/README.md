...
Lifecycle: `POST /me/security/informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /me/security/informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/me/security/information-protection/sensitivity-labels"
}
```
