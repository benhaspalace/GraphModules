...
Lifecycle: `POST /dataClassification/sensitivityLabels/{sensitivityLabel-id}/sublabels`, `GET/PATCH/DELETE /dataClassification/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/data-classification/sensitivity-labels/by-sensitivity-label-id/sublabels"
