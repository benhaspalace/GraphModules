...
Lifecycle: `POST /dataClassification/sensitivityLabels`, `GET/PATCH/DELETE /dataClassification/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/data-classification/sensitivity-labels"
}
```
