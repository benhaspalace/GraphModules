...
Lifecycle: `POST /sites/{site-id}/informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /sites/{site-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/sites/by-site-id/information-protection/sensitivity-labels"
