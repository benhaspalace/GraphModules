...
Lifecycle: `POST /users/{user-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels`, `GET/PATCH/DELETE /users/{user-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/users/by-user-id/information-protection/sensitivity-labels/by-sensitivity-label-id/sublabels"
