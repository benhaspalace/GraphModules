...
Lifecycle: `POST /users/{user-id}/informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /users/{user-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/users/by-user-id/information-protection/sensitivity-labels"
