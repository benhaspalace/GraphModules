...
Lifecycle: `POST /users/{user-id}/security/informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /users/{user-id}/security/informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/users/by-user-id/security/information-protection/sensitivity-labels"
...
| `content_formats` | `contentFormats` | `list(string)` | no | no |
| `description` | `description` | `string` | no | no |
| `has_protection` | `hasProtection` | `bool` | no | no |
| `is_active` | `isActive` | `bool` | no | no |
| `is_appliable` | `isAppliable` | `bool` | no | no |
