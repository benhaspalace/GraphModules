...
Lifecycle: `POST /security/informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /security/informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/information-protection/sensitivity-labels"
}
```
