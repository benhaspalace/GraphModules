...
Lifecycle: `POST /security/providerTenantSettings`, `GET/PATCH/DELETE /security/providerTenantSettings/{providerTenantSetting-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/provider-tenant-settings"
}
```
