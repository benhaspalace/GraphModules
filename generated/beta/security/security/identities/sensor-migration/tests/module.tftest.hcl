...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "security/identities/sensorMigration"
    error_message = "The collection URL must include parent identifiers and exclude the API-version prefix."
  }

  assert {
    condition     = alltrue([for key in ["createdDateTime", "displayName", "domainName", "version", "healthStatus", "migrationState", "sensorType", "serviceStatus"] : !contains(keys(msgraph_resource.this.body), key)])
