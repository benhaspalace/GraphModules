...
[Catalog](../../../../README.md) · [Security](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/trainingcampaign?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /security/attackSimulation/trainingCampaigns`, `GET/PATCH/DELETE /security/attackSimulation/trainingCampaigns/{trainingCampaign-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/attack-simulation/training-campaigns"
}
```
...
| --- | --- | --- | --- | --- |
| `campaign_schedule` | `campaignSchedule` | `any` | no | no |
...
- campaignSchedule: polymorphic schema; accepts an untyped value
