...
[Catalog](../../../../README.md) · [Security](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/payload?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /security/attackSimulation/payloads`, `GET/PATCH/DELETE /security/attackSimulation/payloads/{payload-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/attack-simulation/payloads"
}
```
