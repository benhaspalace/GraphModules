...
Lifecycle: `POST /security/userSecurityProfiles`, `GET/PATCH/DELETE /security/userSecurityProfiles/{userSecurityProfile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/user-security-profiles"
}
```
