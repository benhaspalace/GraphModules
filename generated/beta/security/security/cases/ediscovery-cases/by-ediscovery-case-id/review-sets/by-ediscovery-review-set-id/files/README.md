...
Lifecycle: `POST /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/{ediscoveryReviewSet-id}/files`, `GET/PATCH/DELETE /security/cases/ediscoveryCases/{ediscoveryCase-id}/reviewSets/{ediscoveryReviewSet-id}/files/{ediscoveryFile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/cases/ediscovery-cases/by-ediscovery-case-id/review-sets/by-ediscovery-review-set-id/files"
...
| `custodian` | `custodian` | `any` | no | no |
| `date_time` | `dateTime` | `string` | no | no |
| `extension` | `extension` | `string` | no | no |
| `extracted_text_content` | `extractedTextContent` | `string` | no | no |
| `media_type` | `mediaType` | `string` | no | no |
