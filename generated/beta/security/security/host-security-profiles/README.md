...
Lifecycle: `POST /security/hostSecurityProfiles`, `GET/PATCH/DELETE /security/hostSecurityProfiles/{hostSecurityProfile-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/host-security-profiles"
}
```
...
| `fqdn` | `fqdn` | `string` | no | no |
| `is_azure_ad_joined` | `isAzureAdJoined` | `bool` | no | no |
...
| `parent_host` | `parentHost` | `string` | no | no |
