...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/groups/by-group-id/sites/by-site-id/information-protection/sensitivity-labels/by-sensitivity-label-id/sublabels"
