...
[Catalog](../../../../../../../README.md) · [Security](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/threatassessmentrequest?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /groups/{group-id}/sites/{site-id}/informationProtection/threatAssessmentRequests`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/groups/by-group-id/sites/by-site-id/information-protection/threat-assessment-requests"
