...
Lifecycle: `POST /informationProtection/threatAssessmentRequests`, `GET/PATCH/DELETE /informationProtection/threatAssessmentRequests/{threatAssessmentRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/information-protection/threat-assessment-requests"
}
```
