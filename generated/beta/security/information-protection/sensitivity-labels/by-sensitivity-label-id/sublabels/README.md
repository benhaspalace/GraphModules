...
Lifecycle: `POST /informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels`, `GET/PATCH/DELETE /informationProtection/sensitivityLabels/{sensitivityLabel-id}/sublabels/{sensitivityLabel-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/information-protection/sensitivity-labels/by-sensitivity-label-id/sublabels"
