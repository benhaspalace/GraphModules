...
Lifecycle: `POST /informationProtection/sensitivityLabels`, `GET/PATCH/DELETE /informationProtection/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/information-protection/sensitivity-labels"
}
```
