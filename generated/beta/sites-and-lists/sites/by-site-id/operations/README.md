...
Lifecycle: `POST /sites/{site-id}/operations`, `GET/PATCH/DELETE /sites/{site-id}/operations/{richLongRunningOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/operations"
