...
Lifecycle: `POST /sites/{site-id}/analytics/itemActivityStats`, `GET/PATCH/DELETE /sites/{site-id}/analytics/itemActivityStats/{itemActivityStat-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/analytics/item-activity-stats"
