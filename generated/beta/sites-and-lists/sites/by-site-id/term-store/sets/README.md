...
Lifecycle: `POST /sites/{site-id}/termStore/sets`, `GET/PATCH/DELETE /sites/{site-id}/termStore/sets/{set-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-store/sets"
