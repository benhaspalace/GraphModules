...
Lifecycle: `POST /sites/{site-id}/termStore/sets/{set-id}/terms`, `GET/PATCH/DELETE /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-store/sets/by-set-id/terms"
