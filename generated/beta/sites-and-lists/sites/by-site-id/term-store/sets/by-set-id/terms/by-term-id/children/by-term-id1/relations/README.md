...
Lifecycle: `POST /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/children/{term-id1}/relations`, `GET/PATCH/DELETE /sites/{site-id}/termStore/sets/{set-id}/terms/{term-id}/children/{term-id1}/relations/{relation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-store/sets/by-set-id/terms/by-term-id/children/by-term-id1/relations"
