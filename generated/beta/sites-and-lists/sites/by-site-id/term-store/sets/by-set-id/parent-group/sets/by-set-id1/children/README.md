...
Lifecycle: `POST /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children`, `GET/PATCH/DELETE /sites/{site-id}/termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-store/sets/by-set-id/parent-group/sets/by-set-id1/children"
