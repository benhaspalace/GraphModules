...
Lifecycle: `POST /sites/{site-id}/contentTypes`, `GET/PATCH/DELETE /sites/{site-id}/contentTypes/{contentType-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/content-types"
