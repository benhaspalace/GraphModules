...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}/activities/{itemActivityOLD-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/lists/by-list-id/items/by-list-item-id/activities"
