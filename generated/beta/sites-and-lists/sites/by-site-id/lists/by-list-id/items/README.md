...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/items`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/items/{listItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/lists/by-list-id/items"
