...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/contentTypes`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/contentTypes/{contentType-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/lists/by-list-id/content-types"
