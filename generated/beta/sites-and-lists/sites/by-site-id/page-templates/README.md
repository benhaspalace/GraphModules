...
Lifecycle: `POST /sites/{site-id}/pageTemplates`, `GET/PATCH/DELETE /sites/{site-id}/pageTemplates/{pageTemplate-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/page-templates"
