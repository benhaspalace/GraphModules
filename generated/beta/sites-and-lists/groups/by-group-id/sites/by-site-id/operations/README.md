...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/operations`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/operations/{richLongRunningOperation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/operations"
