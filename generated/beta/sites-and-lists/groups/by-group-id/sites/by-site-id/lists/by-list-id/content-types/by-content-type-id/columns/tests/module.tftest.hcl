...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "groups/test-parent-id/sites/test-parent-id/lists/test-parent-id/contentTypes/test-parent-id/columns"
    error_message = "The collection URL must include parent identifiers and exclude the API-version prefix."
  }

  assert {
    condition     = alltrue([for key in ["boolean", "calculated", "choice", "columnGroup", "contentApprovalStatus", "currency", "dateTime", "defaultValue", "description", "displayName", "enforceUniqueValues", "geolocation", "hidden", "hyperlinkOrPicture", "indexed", "isDeletable", "isSealed", "isSearchable", "lookup", "name", "number", "personOrGroup", "propagateChanges", "readOnly", "required", "sourceColumn", "sourceContentType", "term", "text", "thumbnail", "validation"] : !contains(keys(msgraph_resource.this.body), key)])
