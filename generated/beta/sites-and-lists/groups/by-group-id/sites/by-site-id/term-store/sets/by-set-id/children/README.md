...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/children`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/termStore/sets/{set-id}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/term-store/sets/by-set-id/children"
