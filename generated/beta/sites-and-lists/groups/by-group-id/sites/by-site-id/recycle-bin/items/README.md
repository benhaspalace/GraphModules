...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/recycleBin/items`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/recycleBin/items/{recycleBinItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/recycle-bin/items"
