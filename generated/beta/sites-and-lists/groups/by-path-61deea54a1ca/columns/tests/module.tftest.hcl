...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "groups/test-parent-id/sites/test-parent-id/pageTemplates/test-parent-id/canvasLayout/horizontalSections/test-parent-id/columns"
