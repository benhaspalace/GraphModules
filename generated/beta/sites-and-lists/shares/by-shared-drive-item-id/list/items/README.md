...
Lifecycle: `POST /shares/{sharedDriveItem-id}/list/items`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/items/{listItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/items"
