...
Lifecycle: `POST /drives/{drive-id}/list/items/{listItem-id}/activities`, `GET/PATCH/DELETE /drives/{drive-id}/list/items/{listItem-id}/activities/{itemActivityOLD-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/drives/by-drive-id/list/items/by-list-item-id/activities"
