...
Lifecycle: `POST /termStore/sets/{set-id}/terms`, `GET/PATCH/DELETE /termStore/sets/{set-id}/terms/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/sets/by-set-id/terms"
