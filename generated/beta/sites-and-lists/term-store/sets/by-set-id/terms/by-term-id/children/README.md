# /termStore/sets/{set-id}/terms/{term-id}/children
...
Lifecycle: `POST /termStore/sets/{set-id}/terms/{term-id}/children`, `GET/PATCH/DELETE /termStore/sets/{set-id}/terms/{term-id}/children/{term-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/sets/by-set-id/terms/by-term-id/children"
