...
Lifecycle: `POST /termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children`, `GET/PATCH/DELETE /termStore/sets/{set-id}/parentGroup/sets/{set-id1}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/sets/by-set-id/parent-group/sets/by-set-id1/children"
