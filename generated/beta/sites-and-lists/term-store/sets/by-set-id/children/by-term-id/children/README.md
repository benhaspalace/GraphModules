...
Lifecycle: `POST /termStore/sets/{set-id}/children/{term-id}/children`, `GET/PATCH/DELETE /termStore/sets/{set-id}/children/{term-id}/children/{term-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/sets/by-set-id/children/by-term-id/children"
