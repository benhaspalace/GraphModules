...
Lifecycle: `POST /termStore/groups/{group-id}/sets/{set-id}/terms`, `GET/PATCH/DELETE /termStore/groups/{group-id}/sets/{set-id}/terms/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/groups/by-group-id/sets/by-set-id/terms"
