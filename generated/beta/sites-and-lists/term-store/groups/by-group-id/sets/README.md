# /termStore/groups/{group-id}/sets
...
Lifecycle: `POST /termStore/groups/{group-id}/sets`, `GET/PATCH/DELETE /termStore/groups/{group-id}/sets/{set-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/term-store/groups/by-group-id/sets"
