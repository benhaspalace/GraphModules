...
Lifecycle: `POST /agents`, `GET/PATCH/DELETE /agents/{agent-id}`.
...
| --- | --- | --- | --- | --- |
| `copilot_tools` | `copilotTools` | `list(object({       odata_type = optional(string, "#microsoft.graph.copilotTool")       copilotToolName = optional(string)       url = optional(string)     }))` | no | no |
