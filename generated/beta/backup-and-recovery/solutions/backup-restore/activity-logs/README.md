# /solutions/backupRestore/activityLogs

Create new navigation property to activityLogs for solutions

[Catalog](../../../../README.md) · [Backup and recovery](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/tenants-backup-recovery-overview?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /solutions/backupRestore/activityLogs`, `GET/PATCH/DELETE /solutions/backupRestore/activityLogs/{activityLogBase-id}`.
