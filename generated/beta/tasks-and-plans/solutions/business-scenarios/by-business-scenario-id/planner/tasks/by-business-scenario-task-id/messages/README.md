# /solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/messages
...
Lifecycle: `POST /solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/messages`, `GET/PATCH/DELETE /solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}/messages/{plannerTaskChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/solutions/business-scenarios/by-business-scenario-id/planner/tasks/by-business-scenario-task-id/messages"
  business_scenario_id = "parent-object-id"
  business_scenario_task_id = "parent-object-id"
}
```
...
| `business_scenario_task_id` | URL parameter `businessScenarioTask-id` | `string` | yes | no |
