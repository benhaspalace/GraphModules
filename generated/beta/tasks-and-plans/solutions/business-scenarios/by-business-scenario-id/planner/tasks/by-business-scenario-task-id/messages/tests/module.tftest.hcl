...
run "minimal_request" {
  ...
  variables {
    ...
    business_scenario_task_id = "test-parent-id"
  }

  assert {
    condition     = msgraph_resource.this.url == "solutions/businessScenarios/test-parent-id/planner/tasks/test-parent-id/messages"
