...
[Catalog](../../../../../../README.md) · [Tasks and plans](../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/businessscenariotask?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /solutions/businessScenarios/{businessScenario-id}/planner/tasks`, `GET/PATCH/DELETE /solutions/businessScenarios/{businessScenario-id}/planner/tasks/{businessScenarioTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/solutions/business-scenarios/by-business-scenario-id/planner/tasks"
