...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamwork/teamTemplates/test-parent-id/definitions/test-parent-id/teamDefinition/primaryChannel/planner/plans/test-parent-id/buckets/test-parent-id/tasks/test-parent-id/messages"
