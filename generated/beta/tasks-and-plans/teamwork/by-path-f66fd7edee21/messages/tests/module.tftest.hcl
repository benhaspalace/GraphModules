...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamwork/teamTemplates/test-parent-id/definitions/test-parent-id/teamDefinition/channels/test-parent-id/planner/plans/test-parent-id/buckets/test-parent-id/tasks/test-parent-id/messages"
...
run "invalid_enum" {
  ...
  variables {
    ...
    planner_bucket_id           = "test-parent-id"
    planner_task_id             = "test-parent-id"
    message_type                = "__graphform_invalid_enum__"
  }
