...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamwork/teamTemplates/test-parent-id/definitions/test-parent-id/teamDefinition/primaryChannel/planner/plans/test-parent-id/historyItems"
...
run "invalid_enum" {
  ...
  variables {
    ...
    team_template_definition_id = "test-parent-id"
    planner_plan_id             = "test-parent-id"
    entity_type                 = "__graphform_invalid_enum__"
  }
