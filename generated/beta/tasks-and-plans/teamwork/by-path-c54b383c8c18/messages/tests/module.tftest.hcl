...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamwork/deletedTeams/test-parent-id/channels/test-parent-id/planner/plans/test-parent-id/buckets/test-parent-id/tasks/test-parent-id/messages"
