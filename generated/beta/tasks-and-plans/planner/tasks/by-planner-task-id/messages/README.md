# /planner/tasks/{plannerTask-id}/messages
...
Lifecycle: `POST /planner/tasks/{plannerTask-id}/messages`, `GET/PATCH/DELETE /planner/tasks/{plannerTask-id}/messages/{plannerTaskChatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/planner/tasks/by-planner-task-id/messages"
