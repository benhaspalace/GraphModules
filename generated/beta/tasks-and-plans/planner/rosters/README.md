...
[Catalog](../../../README.md) · [Tasks and plans](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/plannerroster?view=graph-rest-beta&preserve-view=true)

Generated from Microsoft Graph **beta** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /planner/rosters`, `GET/PATCH/DELETE /planner/rosters/{plannerRoster-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/planner/rosters"
}
```
