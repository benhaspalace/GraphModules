# /teams/{team-id}/primaryChannel/planner/plans
...
Lifecycle: `POST /teams/{team-id}/primaryChannel/planner/plans`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/planner/plans/{plannerPlan-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/teams/by-team-id/primary-channel/planner/plans"
