...
Lifecycle: `POST /teams/{team-id}/primaryChannel/planner/plans/{plannerPlan-id}/buckets`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/teams/by-team-id/primary-channel/planner/plans/by-planner-plan-id/buckets"
