...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamTemplateDefinition/test-parent-id/teamDefinition/channels/test-parent-id/planner/plans/test-parent-id/tasks/test-parent-id/messages"
