...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "teamTemplateDefinition/test-parent-id/teamDefinition/primaryChannel/planner/plans/test-parent-id/tasks/test-parent-id/messages"
