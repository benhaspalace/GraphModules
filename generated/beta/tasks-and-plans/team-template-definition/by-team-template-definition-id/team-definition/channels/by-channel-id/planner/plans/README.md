...
Lifecycle: `POST /teamTemplateDefinition/{teamTemplateDefinition-id}/teamDefinition/channels/{channel-id}/planner/plans`, `GET/PATCH/DELETE /teamTemplateDefinition/{teamTemplateDefinition-id}/teamDefinition/channels/{channel-id}/planner/plans/{plannerPlan-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/team-template-definition/by-team-template-definition-id/team-definition/channels/by-channel-id/planner/plans"
