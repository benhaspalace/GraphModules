# /groups/{group-id}/team/channels/{channel-id}/planner/plans/{plannerPlan-id}/tasks
...
Lifecycle: `POST /groups/{group-id}/team/channels/{channel-id}/planner/plans/{plannerPlan-id}/tasks`, `GET/PATCH/DELETE /groups/{group-id}/team/channels/{channel-id}/planner/plans/{plannerPlan-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/groups/by-group-id/team/channels/by-channel-id/planner/plans/by-planner-plan-id/tasks"
