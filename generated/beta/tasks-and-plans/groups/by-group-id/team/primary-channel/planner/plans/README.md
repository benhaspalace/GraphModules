...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/planner/plans`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/planner/plans/{plannerPlan-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/groups/by-group-id/team/primary-channel/planner/plans"
