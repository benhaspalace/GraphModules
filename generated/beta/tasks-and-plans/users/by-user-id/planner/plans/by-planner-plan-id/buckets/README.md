...
Lifecycle: `POST /users/{user-id}/planner/plans/{plannerPlan-id}/buckets`, `GET/PATCH/DELETE /users/{user-id}/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/users/by-user-id/planner/plans/by-planner-plan-id/buckets"
