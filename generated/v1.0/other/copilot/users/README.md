...
[Catalog](../../../README.md) · [Uncategorized](../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/overview?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /copilot/users`, `GET/PATCH/DELETE /copilot/users/{aiUser-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./other/copilot/users"
}
```
