...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "education/me/assignments/test-parent-id/submissions/test-parent-id/submittedResources/test-parent-id/dependentResources"
