...
[Catalog](../../../../../README.md) · [Education](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/educationassignment?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /education/classes/{educationClass-id}/assignments`, `GET/PATCH/DELETE /education/classes/{educationClass-id}/assignments/{educationAssignment-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./education/education/classes/by-education-class-id/assignments"
