...
[Catalog](../../../../../../../../README.md) · [Change notifications](../../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/subscription?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /groups/{group-id}/sites/{site-id}/lists/{list-id}/subscriptions`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./change-notifications/groups/by-group-id/sites/by-site-id/lists/by-list-id/subscriptions"
