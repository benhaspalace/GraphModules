...
Lifecycle: `POST /sites/{site-id}/lists/{list-id}/subscriptions`, `GET/PATCH/DELETE /sites/{site-id}/lists/{list-id}/subscriptions/{subscription-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./change-notifications/sites/by-site-id/lists/by-list-id/subscriptions"
