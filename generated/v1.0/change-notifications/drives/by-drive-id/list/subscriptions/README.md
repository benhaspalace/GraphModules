...
Lifecycle: `POST /drives/{drive-id}/list/subscriptions`, `GET/PATCH/DELETE /drives/{drive-id}/list/subscriptions/{subscription-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./change-notifications/drives/by-drive-id/list/subscriptions"
