...
Lifecycle: `POST /communications/onlineMeetingConversations/{onlineMeetingEngagementConversation-id}/messages/{engagementConversationMessage-id}/replies/{engagementConversationMessage-id1}/reactions`, `GET/PATCH/DELETE /communications/onlineMeetingConversations/{onlineMeetingEngagementConversation-id}/messages/{engagementConversationMessage-id}/replies/{engagementConversationMessage-id1}/reactions/{engagementConversationMessageReaction-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/communications/by-path-f65ef6b50630/reactions"
  online_meeting_engagement_conversation_id = "parent-object-id"
  engagement_conversation_message_id = "parent-object-id"
  engagement_conversation_message_id1 = "parent-object-id"
}
```
