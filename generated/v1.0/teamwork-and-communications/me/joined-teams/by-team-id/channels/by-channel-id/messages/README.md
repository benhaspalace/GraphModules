...
Lifecycle: `POST /me/joinedTeams/{team-id}/channels/{channel-id}/messages`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/channels/by-channel-id/messages"
