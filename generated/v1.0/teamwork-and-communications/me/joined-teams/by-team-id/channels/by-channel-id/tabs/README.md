...
Lifecycle: `POST /me/joinedTeams/{team-id}/channels/{channel-id}/tabs`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/channels/{channel-id}/tabs/{teamsTab-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/channels/by-channel-id/tabs"
