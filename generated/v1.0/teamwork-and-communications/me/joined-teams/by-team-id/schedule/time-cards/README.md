...
Lifecycle: `POST /me/joinedTeams/{team-id}/schedule/timeCards`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/schedule/timeCards/{timeCard-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/schedule/time-cards"
