...
Lifecycle: `POST /me/joinedTeams/{team-id}/schedule/openShifts`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/schedule/openShifts/{openShift-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/schedule/open-shifts"
