...
Lifecycle: `POST /me/joinedTeams/{team-id}/schedule/timeOffRequests`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/schedule/timeOffRequests/{timeOffRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/schedule/time-off-requests"
