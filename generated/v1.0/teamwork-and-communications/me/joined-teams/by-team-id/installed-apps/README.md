...
Lifecycle: `POST /me/joinedTeams/{team-id}/installedApps`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/installed-apps"
