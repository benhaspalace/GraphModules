...
Lifecycle: `POST /me/joinedTeams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/primaryChannel/messages/{chatMessage-id}/replies/{chatMessage-id1}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/primary-channel/messages/by-chat-message-id/replies"
