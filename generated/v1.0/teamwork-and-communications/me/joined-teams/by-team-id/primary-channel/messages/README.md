...
Lifecycle: `POST /me/joinedTeams/{team-id}/primaryChannel/messages`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/primaryChannel/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/me/joined-teams/by-team-id/primary-channel/messages"
