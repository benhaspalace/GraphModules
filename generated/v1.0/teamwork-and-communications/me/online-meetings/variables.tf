...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["attendanceReports", "attendeeReport", "audioConferencing", "cloudVideoInteropInfo", "creationDateTime", "id", "joinInformation", "joinWebUrl", "meetingType", "recordings", "transcripts", "videoTeleconferenceId"], key)]) : false
