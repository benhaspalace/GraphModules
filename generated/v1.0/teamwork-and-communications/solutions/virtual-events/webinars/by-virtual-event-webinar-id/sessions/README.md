...
Lifecycle: `POST /solutions/virtualEvents/webinars/{virtualEventWebinar-id}/sessions`, `GET/PATCH/DELETE /solutions/virtualEvents/webinars/{virtualEventWebinar-id}/sessions/{virtualEventSession-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/solutions/virtual-events/webinars/by-virtual-event-webinar-id/sessions"
