...
Lifecycle: `POST /chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/replies`, `GET/PATCH/DELETE /chats/{chat-id}/targetedMessages/{targetedChatMessage-id}/replies/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/chats/by-chat-id/targeted-messages/by-targeted-chat-message-id/replies"
