...
Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/installedApps`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/installedApps/{teamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/joined-teams/by-team-id/installed-apps"
