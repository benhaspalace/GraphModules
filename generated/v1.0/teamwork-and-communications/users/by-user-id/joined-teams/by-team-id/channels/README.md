...
Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/channels`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/channels/{channel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/joined-teams/by-team-id/channels"
