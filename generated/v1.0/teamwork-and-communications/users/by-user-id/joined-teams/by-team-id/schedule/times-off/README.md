...
[Catalog](../../../../../../../README.md) · [Teamwork and communications](../../../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/timeoff?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/schedule/timesOff`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/schedule/timesOff/{timeOff-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/joined-teams/by-team-id/schedule/times-off"
