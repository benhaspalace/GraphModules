...
Lifecycle: `POST /users/{user-id}/chats/{chat-id}/tabs`, `GET/PATCH/DELETE /users/{user-id}/chats/{chat-id}/tabs/{teamsTab-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/chats/by-chat-id/tabs"
