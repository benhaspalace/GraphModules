...
Lifecycle: `POST /users/{user-id}/teamwork/installedApps`, `GET/PATCH/DELETE /users/{user-id}/teamwork/installedApps/{userScopeTeamsAppInstallation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/users/by-user-id/teamwork/installed-apps"
...
- chat: polymorphic schema; accepts an untyped value
