...
variable "operation_type" {
  ...
  validation {
    condition     = var.operation_type == null ? true : contains(["invalid", "cloneTeam", "archiveTeam", "unarchiveTeam", "createTeam", "unknownFutureValue", "teamifyGroup", "createChannel", "archiveChannel", "unarchiveChannel"], var.operation_type)
