...
Lifecycle: `POST /teams/{team-id}/members`, `GET/PATCH/DELETE /teams/{team-id}/members/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/members"
