...
Lifecycle: `POST /teams/{team-id}/channels/{channel-id}/messages`, `GET/PATCH/DELETE /teams/{team-id}/channels/{channel-id}/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/channels/by-channel-id/messages"
