...
Lifecycle: `POST /teams/{team-id}/primaryChannel/members`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/members/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/primary-channel/members"
