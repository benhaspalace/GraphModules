...
Lifecycle: `POST /teams/{team-id}/primaryChannel/messages`, `GET/PATCH/DELETE /teams/{team-id}/primaryChannel/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/teams/by-team-id/primary-channel/messages"
