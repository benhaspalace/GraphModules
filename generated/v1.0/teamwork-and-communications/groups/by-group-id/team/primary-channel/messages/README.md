...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/messages`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/messages/{chatMessage-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/messages"
