...
Lifecycle: `POST /groups/{group-id}/team/primaryChannel/allMembers`, `GET/PATCH/DELETE /groups/{group-id}/team/primaryChannel/allMembers/{conversationMember-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/primary-channel/all-members"
