...
Lifecycle: `POST /groups/{group-id}/team/channels/{channel-id}/tabs`, `GET/PATCH/DELETE /groups/{group-id}/team/channels/{channel-id}/tabs/{teamsTab-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/channels/by-channel-id/tabs"
