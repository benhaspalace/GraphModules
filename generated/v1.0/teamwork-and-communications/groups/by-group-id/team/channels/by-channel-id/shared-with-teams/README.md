...
Lifecycle: `POST /groups/{group-id}/team/channels/{channel-id}/sharedWithTeams`, `GET/PATCH/DELETE /groups/{group-id}/team/channels/{channel-id}/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/channels/by-channel-id/shared-with-teams"
