...
Lifecycle: `POST /groups/{group-id}/team/schedule/timeCards`, `GET/PATCH/DELETE /groups/{group-id}/team/schedule/timeCards/{timeCard-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./teamwork-and-communications/groups/by-group-id/team/schedule/time-cards"
