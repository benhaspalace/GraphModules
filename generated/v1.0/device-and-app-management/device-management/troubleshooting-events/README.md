...
Lifecycle: `POST /deviceManagement/troubleshootingEvents`, `GET/PATCH/DELETE /deviceManagement/troubleshootingEvents/{deviceManagementTroubleshootingEvent-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./device-and-app-management/device-management/troubleshooting-events"
}
```
