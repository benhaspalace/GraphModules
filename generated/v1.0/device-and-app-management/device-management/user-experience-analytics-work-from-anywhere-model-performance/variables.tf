...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["cloudIdentityScore", "cloudManagementScore", "cloudProvisioningScore", "id", "manufacturer", "model", "modelDeviceCount", "windowsScore", "workFromAnywhereScore"], key)]) : false
