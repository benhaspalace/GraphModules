...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["assignments", "createdDateTime", "description", "displayName", "version", "lastModifiedDateTime", "priority"] : !contains(keys(msgraph_resource.this.body), key)])
