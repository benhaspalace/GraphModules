...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["allowedDataStorageLocations", "allowedInboundDataTransferSources", "allowedOutboundClipboardSharingLevel", "allowedOutboundDataTransferDestinations", "appDataEncryptionType", "apps", "assignments", "contactSyncBlocked", "createdDateTime", "customBrowserProtocol", "dataBackupBlocked", "deployedAppCount", "deploymentSummary", "description", "deviceComplianceRequired", "disableAppPinIfDevicePinIsSet", "displayName", "faceIdBlocked", "fingerprintBlocked", "version", "isAssigned", "lastModifiedDateTime", "managedBrowser", "managedBrowserToOpenLinksRequired", "maximumPinRetries", "minimumPinLength", "minimumRequiredAppVersion", "minimumRequiredOsVersion", "minimumRequiredSdkVersion", "minimumWarningAppVersion", "minimumWarningOsVersion", "organizationalCredentialsRequired", "periodBeforePinReset", "periodOfflineBeforeAccessCheck", "periodOfflineBeforeWipeIsEnforced", "periodOnlineBeforeAccessCheck", "pinCharacterSet", "pinRequired", "printBlocked", "saveAsBlocked", "simplePinBlocked"] : !contains(keys(msgraph_resource.this.body), key)])
