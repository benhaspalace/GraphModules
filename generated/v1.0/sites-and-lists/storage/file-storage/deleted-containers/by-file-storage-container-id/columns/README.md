...
Lifecycle: `POST /storage/fileStorage/deletedContainers/{fileStorageContainer-id}/columns`, `GET/PATCH/DELETE /storage/fileStorage/deletedContainers/{fileStorageContainer-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/storage/file-storage/deleted-containers/by-file-storage-container-id/columns"
