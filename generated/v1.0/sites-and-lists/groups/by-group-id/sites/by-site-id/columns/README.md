...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/columns`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-group-id/sites/by-site-id/columns"
