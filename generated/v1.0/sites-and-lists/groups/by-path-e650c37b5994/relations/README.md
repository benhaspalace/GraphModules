...
Lifecycle: `POST /groups/{group-id}/sites/{site-id}/termStores/{store-id}/groups/{group-id1}/sets/{set-id}/terms/{term-id}/children/{term-id1}/relations`, `GET/PATCH/DELETE /groups/{group-id}/sites/{site-id}/termStores/{store-id}/groups/{group-id1}/sets/{set-id}/terms/{term-id}/children/{term-id1}/relations/{relation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/groups/by-path-e650c37b5994/relations"
