...
Lifecycle: `POST /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/children/{term-id1}/relations`, `GET/PATCH/DELETE /sites/{site-id}/termStores/{store-id}/sets/{set-id}/parentGroup/sets/{set-id1}/terms/{term-id}/children/{term-id1}/relations/{relation-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-path-544427b2612c/relations"
