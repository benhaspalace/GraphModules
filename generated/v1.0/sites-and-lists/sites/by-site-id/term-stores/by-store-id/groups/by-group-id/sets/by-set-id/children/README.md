...
Lifecycle: `POST /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/children`, `GET/PATCH/DELETE /sites/{site-id}/termStores/{store-id}/groups/{group-id}/sets/{set-id}/children/{term-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/sites/by-site-id/term-stores/by-store-id/groups/by-group-id/sets/by-set-id/children"
