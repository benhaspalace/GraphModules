...
Lifecycle: `POST /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columns`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/contentTypes/{contentType-id}/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/content-types/by-content-type-id/columns"
