...
Lifecycle: `POST /shares/{sharedDriveItem-id}/list/columns`, `GET/PATCH/DELETE /shares/{sharedDriveItem-id}/list/columns/{columnDefinition-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./sites-and-lists/shares/by-shared-drive-item-id/list/columns"
