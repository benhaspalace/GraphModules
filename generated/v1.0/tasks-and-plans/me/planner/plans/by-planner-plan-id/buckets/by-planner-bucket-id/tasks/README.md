...
Lifecycle: `POST /me/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks`, `GET/PATCH/DELETE /me/planner/plans/{plannerPlan-id}/buckets/{plannerBucket-id}/tasks/{plannerTask-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./tasks-and-plans/me/planner/plans/by-planner-plan-id/buckets/by-planner-bucket-id/tasks"
