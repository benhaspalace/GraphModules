...
Lifecycle: `POST /me/joinedTeams/{team-id}/primaryChannel/sharedWithTeams`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/me/joined-teams/by-team-id/primary-channel/shared-with-teams"
