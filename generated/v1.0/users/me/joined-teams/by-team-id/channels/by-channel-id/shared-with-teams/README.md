...
Lifecycle: `POST /me/joinedTeams/{team-id}/channels/{channel-id}/sharedWithTeams`, `GET/PATCH/DELETE /me/joinedTeams/{team-id}/channels/{channel-id}/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/me/joined-teams/by-team-id/channels/by-channel-id/shared-with-teams"
