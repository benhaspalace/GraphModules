...
Lifecycle: `POST /users/{user-id}/joinedTeams/{team-id}/primaryChannel/sharedWithTeams`, `GET/PATCH/DELETE /users/{user-id}/joinedTeams/{team-id}/primaryChannel/sharedWithTeams/{sharedWithChannelTeamInfo-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./users/users/by-user-id/joined-teams/by-team-id/primary-channel/shared-with-teams"
