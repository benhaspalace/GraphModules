...
Lifecycle: `POST /security/subjectRightsRequests/{subjectRightsRequest-id}/notes`, `GET/PATCH/DELETE /security/subjectRightsRequests/{subjectRightsRequest-id}/notes/{authoredNote-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/subject-rights-requests/by-subject-rights-request-id/notes"
