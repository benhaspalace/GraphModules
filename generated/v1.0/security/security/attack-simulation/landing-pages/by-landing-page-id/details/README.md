...
Lifecycle: `POST /security/attackSimulation/landingPages/{landingPage-id}/details`, `GET/PATCH/DELETE /security/attackSimulation/landingPages/{landingPage-id}/details/{landingPageDetail-id}`.
...
| --- | --- | --- | --- | --- |
| `landing_page_id` | URL parameter `landingPage-id` | `string` | yes | no |
