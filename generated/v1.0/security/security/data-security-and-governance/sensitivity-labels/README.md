...
Lifecycle: `POST /security/dataSecurityAndGovernance/sensitivityLabels`, `GET/PATCH/DELETE /security/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/security/data-security-and-governance/sensitivity-labels"
}
```
