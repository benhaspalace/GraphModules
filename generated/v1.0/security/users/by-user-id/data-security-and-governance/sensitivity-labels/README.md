...
Lifecycle: `POST /users/{user-id}/dataSecurityAndGovernance/sensitivityLabels`, `GET/PATCH/DELETE /users/{user-id}/dataSecurityAndGovernance/sensitivityLabels/{sensitivityLabel-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./security/users/by-user-id/data-security-and-governance/sensitivity-labels"
