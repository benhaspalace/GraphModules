...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/unifiedroleassignmentschedulerequest?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /roleManagement/directory/roleAssignmentScheduleRequests`, `GET/PATCH/DELETE /roleManagement/directory/roleAssignmentScheduleRequests/{unifiedRoleAssignmentScheduleRequest-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/role-management/directory/role-assignment-schedule-requests"
}
```
