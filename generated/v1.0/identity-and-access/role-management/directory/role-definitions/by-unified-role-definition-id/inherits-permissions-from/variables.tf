...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["description", "displayName", "id", "inheritsPermissionsFrom", "isBuiltIn", "isEnabled", "resourceScopes", "rolePermissions", "templateId", "version"], key)]) : false
