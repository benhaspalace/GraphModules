...
Lifecycle: `POST /agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions`, `GET/PATCH/DELETE /agreements/{agreement-id}/file/localizations/{agreementFileLocalization-id}/versions/{agreementFileVersion-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/agreements/by-agreement-id/file/localizations/by-agreement-file-localization-id/versions"
