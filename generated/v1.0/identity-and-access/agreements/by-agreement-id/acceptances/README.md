...
Lifecycle: `POST /agreements/{agreement-id}/acceptances`, `GET/PATCH/DELETE /agreements/{agreement-id}/acceptances/{agreementAcceptance-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/agreements/by-agreement-id/acceptances"
