...
[Catalog](../../../../../README.md) · [Identity and access](../../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/riskyuserhistoryitem?view=graph-rest-1.0&preserve-view=true)

Generated from Microsoft Graph **v1.0** OpenAPI and optional EDMX metadata.

Lifecycle: `POST /identityProtection/riskyUsers/{riskyUser-id}/history`, `GET/PATCH/DELETE /identityProtection/riskyUsers/{riskyUser-id}/history/{riskyUserHistoryItem-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-protection/risky-users/by-risky-user-id/history"
