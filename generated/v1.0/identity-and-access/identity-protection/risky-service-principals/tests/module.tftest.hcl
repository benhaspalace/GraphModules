...
run "minimal_request" {
  ...
  assert {
    condition     = alltrue([for key in ["appId", "displayName", "history", "isEnabled", "isProcessing", "riskDetail", "riskLastUpdatedDateTime", "riskLevel", "riskState", "servicePrincipalType"] : !contains(keys(msgraph_resource.this.body), key)])
