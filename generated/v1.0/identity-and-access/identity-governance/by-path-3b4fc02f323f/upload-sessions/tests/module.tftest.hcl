...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceRoleScopes/test-parent-id/role/resource/scopes/test-parent-id/resource/uploadSessions"
