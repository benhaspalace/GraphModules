...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceRequests/test-parent-id/catalog/resourceRoles/test-parent-id/resource/uploadSessions"
