...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceRoleScopes/test-parent-id/scope/resource/roles/test-parent-id/resource/scopes"
