...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resources/test-parent-id/scopes/test-parent-id/resource/roles/test-parent-id/resource/uploadSessions"
