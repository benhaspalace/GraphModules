...
variable "additional_properties" {
  ...
  validation {
    condition     = can(keys(var.additional_properties)) ? alltrue([for key in keys(var.additional_properties) : !contains(["contactedReviewers", "endDateTime", "errors", "id", "scope", "startDateTime", "status"], key)]) : false
