...
[Catalog](../../../../README.md) · [Identity and access](../../../README.md) · [Microsoft Graph reference](https://learn.microsoft.com/en-us/graph/api/resources/accessreviewhistorydefinition?view=graph-rest-1.0&preserve-view=true)
...
module "graph_resource" {
  source = "./identity-and-access/identity-governance/access-reviews/history-definitions"
}
```
