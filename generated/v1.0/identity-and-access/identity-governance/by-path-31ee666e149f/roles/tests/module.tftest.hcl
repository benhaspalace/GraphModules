...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/catalogs/test-parent-id/resourceRoles/test-parent-id/resource/scopes/test-parent-id/resource/roles"
