# /identityGovernance/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions
...
Lifecycle: `POST /identityGovernance/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions`, `GET/PATCH/DELETE /identityGovernance/catalogs/{accessPackageCatalog-id}/customWorkflowExtensions/{customCalloutExtension-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./identity-and-access/identity-governance/catalogs/by-access-package-catalog-id/custom-workflow-extensions"
