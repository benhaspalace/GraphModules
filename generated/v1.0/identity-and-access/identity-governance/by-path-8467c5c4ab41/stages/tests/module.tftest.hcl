...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/appConsent/appConsentRequests/test-parent-id/userConsentRequests/test-parent-id/approval/stages"
