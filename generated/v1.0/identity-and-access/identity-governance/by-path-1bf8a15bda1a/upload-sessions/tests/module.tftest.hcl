...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/resourceEnvironments/test-parent-id/resources/test-parent-id/scopes/test-parent-id/resource/uploadSessions"
