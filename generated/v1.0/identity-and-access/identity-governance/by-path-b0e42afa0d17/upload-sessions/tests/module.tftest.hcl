...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/catalogs/test-parent-id/resourceScopes/test-parent-id/resource/roles/test-parent-id/resource/uploadSessions"
