...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "identityGovernance/entitlementManagement/accessPackages/test-parent-id/resourceRoleScopes/test-parent-id/role/resource/scopes/test-parent-id/resource/roles"
