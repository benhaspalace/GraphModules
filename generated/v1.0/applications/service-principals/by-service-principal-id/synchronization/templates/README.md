...
Lifecycle: `POST /servicePrincipals/{servicePrincipal-id}/synchronization/templates`, `GET/PATCH/DELETE /servicePrincipals/{servicePrincipal-id}/synchronization/templates/{synchronizationTemplate-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./applications/service-principals/by-service-principal-id/synchronization/templates"
