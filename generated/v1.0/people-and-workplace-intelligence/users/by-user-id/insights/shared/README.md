...
Lifecycle: `POST /users/{user-id}/insights/shared`, `GET/PATCH/DELETE /users/{user-id}/insights/shared/{sharedInsight-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./people-and-workplace-intelligence/users/by-user-id/insights/shared"
