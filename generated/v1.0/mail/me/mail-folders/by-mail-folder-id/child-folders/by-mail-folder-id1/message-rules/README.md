...
Lifecycle: `POST /me/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messageRules`, `GET/PATCH/DELETE /me/mailFolders/{mailFolder-id}/childFolders/{mailFolder-id1}/messageRules/{messageRule-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./mail/me/mail-folders/by-mail-folder-id/child-folders/by-mail-folder-id1/message-rules"
