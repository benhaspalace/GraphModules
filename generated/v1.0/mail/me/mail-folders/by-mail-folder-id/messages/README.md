...
Lifecycle: `POST /me/mailFolders/{mailFolder-id}/messages`, `GET/PATCH/DELETE /me/mailFolders/{mailFolder-id}/messages/{message-id}`.

## Usage

```hcl
module "graph_resource" {
  source = "./mail/me/mail-folders/by-mail-folder-id/messages"
