...
run "minimal_request" {
  ...
  assert {
    condition     = msgraph_resource.this.url == "users/test-parent-id/joinedTeams/test-parent-id/primaryChannel/messages/test-parent-id/replies/test-parent-id/hostedContents"
